...
# save(fed,file="Data/fed_transformed.Rdata")
    ...
    contract<-csis360::read_and_join( large_crisis_smp, #contract,
...
crisis_smp<-add_col_from_transformed(sample=crisis_smp,
                                     transformed=fed)



crisis_with_na<-add_col_from_transformed(sample=crisis_with_na,
                                     transformed=fed)

large_crisis_smp<-add_col_from_transformed(sample=large_crisis_smp,
                                     transformed=fed)


large_crisis_with_na<-add_col_from_transformed(sample=large_crisis_with_na,
                                     transformed=fed)
