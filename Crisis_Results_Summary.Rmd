...
full_data %>%  filter(CrisisDisplay=="Disaster" >=2005) %>%
...
if(!exists("CBre_21E"))
  CBre_21E <- glmer (data=fed_1m,
               ...
               , 
                   family=binomial(link="logit"),
                verbose=1)
  glmer_examine(CBre_21E)

  
# Plot the model and Vehicle 
stargazer::stargazer(CBre_21E,type="text",#Term_20A,#Term_20C
                        digits=2)

summary_residual_compare(CBre_21E,bins=50)


  CBre_21E.all<-allFit_save(CBre_21E,filename="output/CBre_21E_allfit.rdata")
```
...
load("Output//Model22H_CBre.RData")
...
```{r Output-Direct}
# Plot the model and Vehicle 
stargazer::stargazer(CBre_21E,CBre_22H,Term_21D,Term_22G,type="text",
                       digits=2)


summary_residual_compare(CBre_21E,CBre_22H,Term_21D,Term_22G,bins=50)


texreg::htmlreg(list(CBre_21E,CBre_22H,Term_21D,Term_22G),file="Output//Both_Model.html",
                single.row = TRUE,
