...
build_plot(
  ...
  VAR.main.label=NULL,
  VAR.X.label="Fiscal Year",
  VAR.Y.label="Percent of Obligation.2017",
...
LatticePlotWrapper_csis360(
  ...
  VAR.x.variable="Fiscal.Year", #VAR.x.variable
  VAR.y.variable="Obligation.2017", #VAR.y.variable
  VAR.y.series="NoCompOffr", #VAR.y.series Was originally Competition.s
  VAR.facet.primary="DecisionTreeDisplay", #VAR.facet.primary
  ...
  VAR.Y.label="Percent of Obligation.2017",
  labels_and_colors=labels_and_colors,
  data=subset(summary_data, #Originally CompetitionDuration
                     !is.na(UnmodifiedUltimateDurationCategory)),
  # NA, #VAR.ncol
  VAR.x.variable="Fiscal.Year", #VAR.x.variable
  VAR.y.variable="Obligation.2017", #VAR.y.variable
...
build_plot(
  ...
  VAR.Y.label="Percent of Obligation.2017",
  labels_and_colors=labels_and_colors,
  data=subset(summary_data,!is.na(UnmodifiedUltimateDurationCategory)),
  # NA, #VAR.ncol
  VAR.x.variable="Fiscal.Year", #VAR.x.variable
  VAR.y.variable="Obligation.2017", #VAR.y.variable
  VAR.y.series="isUCA", #VAR.y.series
