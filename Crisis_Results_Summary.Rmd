...
ggsave("Output//chapter4topline.eps", device=cairo_pdf, chapter4topline, width=6.5, height= 4, units="in")
...
ggsave("Output//CompOverall.eps", device=cairo_pdf, CompOverall, 
...
ggsave("Output//CompAnnual.eps", device=cairo_pdf, CompAnnual, 
             width=2.5, height= 4, units="in"
             )
