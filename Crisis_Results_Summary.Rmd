...
```{r Output-CBre}
stargazer::stargazer(CBre_21A,CBre_22A,Term_21A,type="text",
                       digits=2)


texreg::htmlreg(list(CBre_21A,CBre_22A,Term_21A),file="Output//CBre_Model.html",#CBre_Comp_13C,CBre_Cons_Comp_15A
                single.row = TRUE,
