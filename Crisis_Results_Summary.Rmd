...
summary_data<-ddply(summary_data,
                    ...
                    plyr::mutate,
                    pDatasetObligation=Obligation.2017/sum(Obligation.2017)
)
...
build_plot(
  ...
  title=NULL,
  xlab="Fiscal Year",
  ylab="Percent of Obligation.2017")
  # +theme(legend.position = "bottom")+
  scale_x_date("Fiscal Year",labels = date_format("'%y"))+
...
build_plot(
  labels_and_colors=labels_and_colors,
  data=subset(summary_data,SupplyServiceERS!="Unlabeled"),
  # NA, #VAR.ncol
  x_var="Fiscal.Year", #x_var
...
build_plot(
  ...
  xlab="Fiscal Year",
  ylab="Percent of Obligation.2017")+theme(legend.position = "bottom")+
    scale_x_date("Fiscal Year",labels = date_format("'%y"))+
  theme(strip.text.y = element_text(angle=270))
...
build_plot(
  ...
  title="Defense Contracts with Labeled Reachback",
  xlab="Fiscal Year",
  yab="Percent of Obligation.2017")+theme(legend.position = "bottom")+
    scale_x_date("Fiscal Year",labels = date_format("'%y"))+
  theme(strip.text.y = element_text(angle=270))
