...
if(!exists("CBre_21A"))
  CBre_21A <- glmer (data=large_crisis_smp,
...
stargazer::stargazer(CBre_21A,#CBre_20A,
                        digits=2)

# summary_residual_compare(CBre_21A,bins=50)
stargazer::stargazer(Term_20G,type="text",#Term_20A,#Term_20C
                        digits=2)

summary_residual_compare(Term_20G,bins=50)
```
###Federal-Wide 21B
```{r Model21B}
# summary(large_crisis_smp$ServCommCons)
...
stargazer::stargazer(CBre_21A,CBre_21B,
                     Term_21A,Term_21B,type="text",#Term_20A,#Term_20C
                        digits=2)
...
if(!exists("Term_22E"))
  ...
  source(system.file("utils", "allFit.R", package="lme4"))
  debug(allFit)
  Term_22E <- allFit(Term_22E,data=crisis_all)
...
stargazer::stargazer(#CBre_21A,CBre_22E,
                     CBre_21A,CBre_22A,CBre_22E,type="text",#Term_20A,#Term_20C
                        digits=2)

stargazer::stargazer(#CBre_21A,CBre_22E,
                     Term_21A,Term_22A,Term_22E,type="text",#Term_20A,#Term_20C
                        digits=2)

summary_residual_compare(CBre_22A,CBre_22E,Term_22A,Term_22E,bins=50)
summary_residual_compare(CBre_21A,CBre_22E,Term_21A,Term_22E,bins=50)
...
stargazer::stargazer(CBre_21A,CBre_21B,CBre_22D,Term_21B,Term_22E,type="text",
                       digits=2)


texreg::htmlreg(list(CBre_21A,CBre_21B,CBre_22E,Term_21B,Term_22E),file="Output//Both_Model.html",
                single.row = TRUE,
                custom.model.name=c("Federal-Wide\nCeiling Breach 1",
                                    "Federal-Wide\nCeiling Breach 2",
                                    "Crisis-Only\nCeiling Breach",
                                    "Federal-Wide\nTermination",
                                    "Crisis-Only\nTermination"
                ...
                groups = list("Study Variables" = 2:10,
                              "Crisis Category" = 11:13,
                              "Contract Characteristics"=14:24,
"Interactions" = 25:33),
