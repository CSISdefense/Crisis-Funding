...
if(!exists("CBre_21E.restart"))
  CBre_21E.restart <- glmer (data=fed_1m,
...
texreg::htmlreg(list(CBre_21E.restart,CBre_22H,Term_21D,Term_22G),file="Output//Both_Model.html",
                single.row = TRUE,
...
or1<-odds_ratio(CBre_21E.restart,"CBre_21E.restart","Federal","Ceiling Breaches")
or2<-odds_ratio(CBre_22H,"CBre_22H","Crisis","Ceiling Breaches")
or3<-odds_ratio(Term_21D,"Term_21D","Federal","Terminations")
or4<-odds_ratio(Term_21D,"Term_22G","Crisis","Terminations")
