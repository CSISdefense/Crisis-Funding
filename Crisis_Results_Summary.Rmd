...
#ContractingOfficeCode
    ...
    colnames(full_data)[colnames(full_data)=="PlaceIntlPercent"]<-"OffIntl"
    full_data$OffPlace<-Hmisc::cut2(full_data$OffIntl,c(0.01,0.50))
...
OMBtheater<-LatticePlotWrapper_csis360(
  ...
  # VAR.facet.secondary="OMBtheater", # VAR.facet.secondary=NA
  # ,MovingAverage=0
  # ,MovingSides=1
  # ,DataLabels=NA
  #                       ,VAR.override.coloration=NA
...
LatticePlotWrapper_csis360(
  VAR.color.legend.label="Contracting Office Place of Performance",
  VAR.main.label=NULL,
  VAR.X.label="Fiscal Year",
  ...
  ,DataLabels=FALSE
  #                       ,VAR.override.coloration=NA
)+theme(legend.position="bottom")+facet_grid(primary~secondary,scales="fixed")
)
