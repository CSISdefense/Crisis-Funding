...
FullData$OCOscore<-cut2(FullData$OCOcrisisScore,c(3,5,7))
...
FullData$OCOlabelDetail[FullData$OCOscore=="[ 7,10]"&is.na(FullData$OCOlabelDetail)]<-"Confident OCO"
FullData$OCOlabelDetail[FullData$OCOscore=="[ 5, 7)"&is.na(FullData$OCOlabelDetail)]<-"Likely OCO"
FullData$OCOlabelDetail[FullData$OCOscore=="[ 3, 5)"&is.na(FullData$OCOlabelDetail)]<-"Possible OCO"
FullData$OCOlabelDetail[FullData$OCOscore=="[ 0, 3)"&is.na(FullData$OCOlabelDetail)]<-"Remainder"
FullData$OCOlabelDetail<-factor(FullData$OCOlabelDetail)
FullData$IsCSISOCO<-FALSE
FullData$IsCSISOCO[FullData$CrisisFunding=="OCO"|FullData$OCOcrisisScore>=5]<-TRUE
