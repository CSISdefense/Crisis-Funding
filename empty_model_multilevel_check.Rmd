...
save(Place_theater_Country_cbre,Place_theater_Country_term,
...
# if(!exists("Place_theater_Country_offplace_theater_cbre"))
  Place_theater_Country_offplace_theater_cbre <- glmer(data=large_crisis_smp,
                       b_CBre ~ place_CrisisFundingTheater+(1 + OffPl99 | PlaceCountryISO3)
                       , family=binomial(link="logit"))
get_icc(display=TRUE,Place_theater_Country_offplace_theater_cbre)

# if(!exists("Place_theater_Country_offplace_theater_term"))
  Place_theater_Country_offplace_theater_term <- glmer(data=large_crisis_smp,
                       b_Term ~ place_CrisisFundingTheater+(1 + OffPl99 | PlaceCountryISO3)
                       , family=binomial(link="logit"))
get_icc(display=TRUE,Place_theater_Country_offplace_theater_term)
