...
load("Output//where_prior_empty_models.rdata")
load("Output//where_empty_models.rdata")
load("Output//placevendororigin_combined.rdata")
load("Output//ssc_prodserv_customer_office_placevendororigin_cbre.rdata")
...
cpsa_prodserv_customer_office_origin_term<-
  update(cpsa_prodserv_customer_office_origin_term)
cpsa_prodserv_customer_office_placevendor_term<-
