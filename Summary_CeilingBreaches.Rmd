...
# CompleteModelAndDetail<-standardize_variable_names(CompleteModelAndDetail)
# labels_and_colors<-csis360::prepare_labels_and_colors(CompleteModelAndDetail)


CompleteModelAndDetail<-transform_contract(CompleteModelAndDetail)
...
NChgCeil<-CompleteModelAndDetail %>% group_by(SumOfisChangeOrder,
                 StartFiscalYear,
                 Ceil)  %>%
  summarise(ContractCount=length(CSIScontractID),
