...
ggsave("Output//Tree5A.png", Tree5A, width=6.5, height= 4, units="in",dpi=300)
...
Tree5B<-LatticePlotWrapper(
  VAR.color.legend.label="Classification After Step 4B",
  VAR.main.label="",
  VAR.X.label="Squareroot of the Share of Product or Service Code Going to Official Contingency Contracts",
  VAR.Y.label="Constant ($ Billions)",
  VAR.Coloration=Coloration,
  VAR.long.DF=subset(defense_data,Customer=="Defense" &
      CrisisFunding %in% c("OCO","Unlabeled","Excluded")),
  ...
  #                       ,VAR.override.coloration=NA
              ...
              , scales="free_y" #The scales actually do stay fixed
              , space="fixed")+
  scale_x_continuous(labels = percent_format())+geom_vline(aes(xintercept=0.05))  
Tree5B
ggsave("Output//Tree5B.png", Tree5B, width=6.5, height= 4, units="in",dpi=300)
...
Tree5C<-LatticePlotWrapper(
  ...
  VAR.main.label="",
  VAR.X.label="Squareroot of the Share of Office Obligations Going to Official Contingency Contracts",
  VAR.Y.label="Constant ($ Billions)",
  VAR.Coloration=Coloration,
  VAR.long.DF=subset(defense_data,Customer=="Defense" &
      CrisisFunding %in% c("OCO","Unlabeled","Excluded")),
  ...
  scale_x_continuous(labels = percent_format())+geom_vline(aes(xintercept=0.05))  
Tree5C
ggsave("Output//Tree5C.png", Tree5C, width=6.5, height= 4, units="in",dpi=300)
...
debug(prepare_labels_and_colors)
OCOdetail<-LatticePlotWrapper(
  ...
  #                       ,VAR.override.coloration=NA
              ...
              , space="fixed")+theme(legend.position="bottom")
OCOdetail
ggsave("Output//AnalysisSumamry.png", OCOdetail, width=6.5, height= 4, units="in",dpi=300)
