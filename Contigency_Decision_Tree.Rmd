...
group_by_names<-function(df,
                         group_var,
                         group_var2){
  # group_var<-as.name(group_var)
  df %>%
    dplyr::group_by(!! as.name(group_var),!! as.name(group_var2)) %>%
    dplyr::summarise(Obligation.2017= sum(Obligation.2017))
}


group_by_names(full_data,"Fiscal.Year","CrisisFunding1A")
...
Tree1A
ggsave600dpi("Output//Figure01_Tree1A.png", Tree1A, width=6.5, height= 3, units="in")
...
ggsave600dpi("Output//Figure02_Tree1B.png", Tree1B, width=6.5, height= 3, units="in")
...
ggsave600dpi("Output//Figure03_Tree1CdetailIsDefense.png", Tree1CdetailIsDefense, width=4, height= 6, units="in")

ggsave("Output//Figure03_Tree1CdetailIsDefense.eps", Tree1CdetailIsDefense, width=4, height= 6, units="in")

ggsave600dpi("Output//Figure04_Tree1CisDefense.png", Tree1CisDefense, width=6.5, height= 3, units="in")
...
ggsave600dpi("Output//Figure05_Tree2.png", Tree2isDefense, width=6.5, height= 3, units="in")
...
#               , space="fixed")+theme(legend.position="bottom")
# 
ggsave600dpi("Output//Figure06_Tree3.png", Tree3, width=4, height= 4.25, units="in")
...
# 
  ...
  Tree4a
ggsave600dpi("Output//Figure07_Tree4a.png", Tree4a, width=6, height= 3.5, units="in")
...
Tree4b
ggsave600dpi("Output//Figure08_Tree4b.png", Tree4b, width=6.5, height= 4, units="in")
...
Tree5A
ggsave600dpi("Output//Figure09_Tree5A.png", Tree5A, width=6.5, height= 2.5, units="in")
...
ggsave600dpi("Output//Figure10_Tree5B.png", Tree5B, width=6.5, height= 2.75, units="in")
...
Tree5C<-LatticePlotWrapper_csis360(
  ...
  scale_x_continuous(labels = percent_format())+geom_vline(aes(xintercept=0.25))  
Tree5C
ggsave600dpi("Output//Figure11_Tree5C.png", Tree5C, width=6.5, height= 2.5, units="in")
...
ggsave600dpi("Output//Figure12_Tree6percent.png", Tree6percent, width=6.5, height= 2.5, units="in")
ggsave("Output//Figure12_Tree6percent.eps", Tree6percent, width=6.5, height= 2.5, units="in")

ggsave600dpi("Output//Figure13_Tree6final.png", Tree6final, width=4, height= 7.5, units="in")
