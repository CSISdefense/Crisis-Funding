...
full_data$CrisisFunding[full_data$CrisisFunding=="Unlabeled" & !is.na(full_data$ContractCrisisFunding)]<-
  full_data$ContractCrisisFunding[full_data$CrisisFunding=="Unlabeled" & !is.na(full_data$ContractCrisisFunding)]
full_data$CrisisFunding[full_data$CrisisFunding=="Unlabeled" & full_data$IsARRAcrisisFunding==1]<-
  "ARRA"
...
ggsave("Output//Tree1A.png", Tree1A, width=6.5, height= 3, units="in",dpi=600)
ggsave("Output//Tree1A.eps", Tree1A, width=6.5, height= 3, units="in")
```
...
ggsave("Output//Tree1B.png", Tree1B, width=6.5, height= 3, units="in",dpi=600)
ggsave("Output//Tree1B.eps", Tree1B, width=6.5, height= 3, units="in")
ggsave("Output//Tree1Bcontradictions.png", Contradictions1B, width=6.5, height= 4.5, units="in",dpi=600)
...
# load("Data//full_data_after_step_1B.Rdata")
...
full_data$Obligation.2017
full_data %>% group_by(nationalinterestactioncodeText) %>% dplyr::summarise(Obligation.2017=sum(Obligation.2017))


  data_1C <- format_data_for_plot(data=subset(full_data,!nationalinterestactioncodeText %in% c("Unlabeled","None")
                     | nationalinterestactioncodeText=="Inauguration 2009"),
                                              share=FALSE,
                                              fy_var="nationalinterestactioncodeText",
                                              # start_fy=start_fy,
                                              # end_fy=end_fy,
                                              y_var="Obligation.2017",
...
full_data$NIAcrisisFunding[
  ...
  data_1C_theater <- format_data_for_plot(data=subset(full_data,(!nationalinterestactioncodeText %in% c("Unlabeled","None")
                     | nationalinterestactioncodeText=="Inauguration 2009" &
                       Theater != "Unlabeled"),
                                              share=FALSE,
                                              fy_var="nationalinterestactioncodeText",
...
ggsave("Output//Tree1CisDefense.png", Tree1CisDefense, width=6.5, height= 3, units="in",dpi=600)
ggsave("Output//Tree1CdetailIsDefense.png", Tree1CdetailIsDefense , width=4, height= 5, units="in",dpi=600)

ggsave("Output//Tree1Coco.png", Tree1Coco, width=6.5, height= 3, units="in",dpi=600)
...
# load(file="Data//full_data_after_step_1C.Rdata")
...
ggsave("Output//Tree2.png", Tree2isDefense, width=6.5, height= 3, units="in",dpi=600)
...
# 
Tree3
ggsave("Output//Tree3.png", Tree3, width=4, height= 6, units="in",dpi=600)
...
# 
  ...
  Tree4a
ggsave("Output//Tree4a.png", Tree4a, width=6, height= 3.5, units="in",dpi=600)
...
Tree4b
ggsave("Output//Tree4b.png", Tree4b, width=6, height= 3.5, units="in",dpi=600)
...
Tree5A
ggsave("Output//Tree5A.png", Tree5A, width=6.5, height= 3, units="in",dpi=600)
sum(defense_data$Obligation.2017[defense_data$CrisisFunding=="OCO"&
...
sum(defense_data$Obligation.2017[defense_data$CrisisFunding=="Excluded"&
      defense_data$Customer=="Defense"& 
      defense_data$Fiscal.Year >=2012&
    defense_data$PercentFundingAccountOCORound1>=0.25],na.rm=TRUE)/
  sum(defense_data$Obligation.2017[defense_data$CrisisFunding=="Excluded"&
      defense_data$Customer=="Defense"& 
      defense_data$Fiscal.Year >=2012],na.rm=TRUE)
sum(defense_data$Obligation.2017[defense_data$CrisisFunding=="Unlabeled"&
      defense_data$Customer=="Defense"& 
      defense_data$Fiscal.Year >=2012&
    defense_data$PercentFundingAccountOCORound1>=0.25],na.rm=TRUE)/
  sum(defense_data$Obligation.2017[defense_data$CrisisFunding=="Unlabeled"&
...
ggsave("Output//Tree5B.png", Tree5B, width=6.5, height= 3, units="in",dpi=600)
