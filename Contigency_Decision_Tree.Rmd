...
annual_summary<- full_data %>% group_by(Fiscal.Year) %>%
  dplyr::summarise(Obligation.2016=sum(Obligation.2016))

crisis_summary<- full_data %>% group_by(CrisisFunding) %>%
  dplyr::summarise(Obligation.2016=sum(Obligation.2016))
...
save(full_data,file="Data//full_data_after_step_1A.Rdata")
```
...
Contradictions1B<-LatticePlotWrapper_csis360_csis360(
...
save(full_data,
  file="Data//full_data_after_step_1B.Rdata")
...
Tree1CdetailIsDefense<-LatticePlotWrapper_csis360(
...
save(full_data,
  file="Data//full_data_after_step_1C.Rdata")
...
save(full_data,
  file="Data//full_data_after_step_2.Rdata")
```
...
save(full_data,
  file="Data//full_data_after_step_3.Rdata")
```
...
save(full_data,
     file="Data//full_data_after_step_4a.Rdata")
```
