...
#               , space="fixed")+theme(legend.position="bottom")
# 
ggsave600dpi("Output//Figure6_Tree3.png", Tree3, width=4, height= 4, units="in")
...
full_data$IsExcludedPSC<-"Remaining"
full_data$IsExcludedPSC[full_data$PSCOCOcrisisScore==-1]<-"Excluded"
full_data$IsExcludedPSC<-factor(full_data$IsExcludedPSC,c("Excluded","Remaining"))
...
full_data$IsExcludedCO<-"Remaining"
