...
##Step 1B: Contigency or Humanitarian Peacekeeping Operation
```{r Step1B}
full_data<-replace_nas_with_unlabeled(full_data,"ContractCrisisFunding")
...
LatticePlotWrapper(
  ...
  VAR.x.variable="Fiscal.Year", #VAR.x.variable
  VAR.y.variable="Obligation.2016", #VAR.y.variable
  VAR.y.series="ContingencyHumanitarianPeacekeepingOperation", #VAR.y.series
  VAR.facet.primary= "ContingencyHumanitarianPeacekeepingOperation", #VAR.facet.primary
