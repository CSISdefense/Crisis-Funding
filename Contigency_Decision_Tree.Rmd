...
full_data$pscOCOcrisisPercentRound1<-round(sqrt(full_data$pscOCOcrisisPercentSqrt),2)
...
ggsave600dpi("Output//Figure10_Tree5B.png", Tree5B, width=6.5, height= 3, units="in")
ggsave("Output//Figure10_Tree5B.eps", Tree5B, width=6.5, height= 3, units="in")
...
full_data$OfficeOCOcrisisPercentRound1<-round(sqrt(full_data$OfficeOCOcrisisPercentSqrt),2)
...
Tree5C<-LatticePlotWrapper_csis360(
  ...
  scale_x_continuous(labels = percent_format())+geom_vline(aes(xintercept=0.25))  
Tree5C
ggsavedpi600("Output//Figure11_Tree5C.png", Tree5C, width=6.5, height= 3, units="in")
ggsave("Output//Figure11_Tree5C.eps", Tree5C, width=6.5, height= 3, units="in")
sum(full_data$Obligation.2017[full_data$CrisisFunding4B=="OCO"&
      full_data$Customer=="Defense"& 
