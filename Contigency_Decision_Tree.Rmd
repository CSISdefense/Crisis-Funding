...
save(full_data,file="Defense_budget_SP_LocationVendorCrisisFundingHistoryBucketCustomerDetail.Rdata")

```

#Decision Tree
##Step 1: Is this contract labeled as a contingency contract
```{r Step1}
...
undebug(LatticePlotWrapper)
#Just ContractCrisisFunding
...
LatticePlotWrapper(
  ...
  VAR.x.variable="Fiscal.Year", #VAR.x.variable
  VAR.y.variable="Obligation.2016", #VAR.y.variable
  VAR.y.series="ContractCrisisFunding", #VAR.y.series
...
LatticePlotWrapper(
  ...
  VAR.Y.label="Constant ($ Billions)",
  VAR.Coloration=Coloration,
  VAR.long.DF=subset(full_data,Theater!='Domestic'),
  # NA, #VAR.ncol
  VAR.x.variable="Fiscal.Year", #VAR.x.variable
  VAR.y.variable="Obligation.2016", #VAR.y.variable
  VAR.y.series="IsOCOcrisisFunding", #VAR.y.series
...
full_data$ContractCrisisFunding
