...
load("Data\\crisis_smp.Rdata")
  ...
  colnames(crisis_smp)[colnames(crisis_smp)=="Agency"]<-"AgencyID"
  crisis_smp<-csis360::read_and_join( crisis_smp,
                                    "Agency_AgencyID.csv",
...
colnames(crisis_smp)[colnames(crisis_smp)=="AgencyID"]<-"Agency"
crisis_smp$Customer<-factor(crisis_smp$Customer)
crisis_smp$DepartmentID<-factor(crisis_smp$DepartmentID)
crisis_smp$SubCustomer<-factor(crisis_smp$SubCustomer)



summary(factor(crisis_smp$Customer)  )
summary(crisis_smp$DepartmentID)
summary(crisis_smp$SubCustomer)
