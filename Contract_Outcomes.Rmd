...
```
Expectations were not met, AIC is improved, though residuals get a bit worse. Leaving out.
...
# Plot the model and Vehicle 
stargazer::stargazer(CBre_10H,CBre_10I,CBre_10J2,type="text",
                        digits=2)
summary_residual_compare(CBre_10H,CBre_10J2,bins=50)
summary_residual_compare(CBre_10I,CBre_10J2,bins=50)
...
# Plot the model and Vehicle 
stargazer::stargazer(CBre_10A,CBre_10H,CBre_20B,CBre_20B,CBre_20I,#CBre_20A,
                     Term_10A,Term_10D,Term_20B,Term_20I,type="text",#Term_20A,#Term_20C
                        digits=2)


stargazer::stargazer(CBre_20I,CBre_20H,
                     Term_20I,Term_20H,type="text",#Term_20A,#Term_20C
                        digits=2)


summary_residual_compare(CBre_10A,CBre_20I,Term_10A,Term_20I,bins=50)
summary_residual_compare(CBre_10D,CBre_20I,Term_10H,Term_20I,bins=50)
summary_residual_compare(CBre_20A,CBre_20I,Term_20A,Term_20I,bins=50)
summary_residual_compare(CBre_20C,CBre_20I,bins=50)#Term_20C,Term_20I,
summary_residual_compare(CBre_20B,CBre_20I,Term_20B,Term_20I,bins=50)
...
### 20I: Back to OffPlace
```{r Model20I}
# summary(large_crisis_smp$ServCommCons)
# summary(large_crisis_smp$CPSA)

fed$OffPlace<-Hmisc::cut2(fed$OffIntl,c(0.01,0.50))
    levels(fed$OffPlace) <-
      list("US99"=c("[0.00,0.01)"),
           "Mixed"=c("[0.01,0.50)"),
           "Intl"=c("[0.50,1.00]"))

  colnames(fed)[colnames(fed)=="Agency"]<-"AgencyID"
fed<-csis360::read_and_join( fed,
                                      "Agency_AgencyID.csv",                                    path="https://raw.githubusercontent.com/CSISdefense/Lookup-Tables/master/",
                                      directory="",
                                      by="AgencyID",
                                      add_var=c("Customer"),
...
colnames(fed)[colnames(fed)=="AgencyID"]<-"Agency"
  
load("Output//Model20I.rdata")


if(!exists("CBre_20I"))
  CBre_20I <- glmer (data=fed_1m,
                   b_CBre ~ Crisis +NoCompOffr +
                     b_UCA+
                     OffPlace+ 
                     cl_Ceil+
  ...
  glmer_examine(CBre_20I)
  save(CBre_20I, file="Output//Model20I.RData")
  
if(!exists("Term_20I"))
  Term_20I <- glmer (data=fed_1m,
                   b_Term ~ Crisis +NoCompOffr+
                     b_UCA+
                     # c_OffCri+
                     OffPlace+ 
     ...
     control = glmerControl(optimizer = "optimx", calc.derivs = FALSE,
     optCtrl = list(method = "nlminb", starttests = FALSE, kkt = FALSE)))
  glmer_examine(Term_20I)
  save(CBre_20I,Term_20I, file="Output//Model20I.RData")
# Plot the model and Vehicle 
stargazer::stargazer(CBre_10A,CBre_10H,CBre_20B,CBre_20B,CBre_20I,#CBre_20A,
                     Term_10A,Term_10D,Term_20B,Term_20I,type="text",#Term_20A,#Term_20C
                        digits=2)

stargazer::stargazer(CBre_20I,type="text",#Term_20A,#Term_20C
                        digits=2)
...
if(!exists("CBre_21A"))
  ...
  # save(CBre_21A, file="Output//Model21A.RData")
  
if(!exists("Term_21A"))
  Term_21A <- glmer (data=disaster,
                   b_Term ~ Crisis +NoCompOffr+
                     b_UCA+
                     # c_OffCri+
                     OffPlace+ 
  ...
  save(CBre_21A,Term_21A, file="Output//Model21A.RData")
# Plot the model and Vehicle 
