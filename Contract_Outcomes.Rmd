...
colnames(recovery_with_na)[colnames(recovery_with_na)=="AgencyID"]<-"Agency"
...
if(!exists("CBre_21A"))
  CBre_21A <- glmer (data=crisis_all,
                   b_CBre ~ Crisis +NoCompOffr +
                     b_UCA+
                     OffPlace+ 
                     cl_Ceil+
...
if(!exists("Term_21A"))
  Term_21A <- glmer (data=crisis_all,
                   b_Term ~ Crisis +NoCompOffr+
                     b_UCA+
                     # c_OffCri+
                     OffPlace+ 
