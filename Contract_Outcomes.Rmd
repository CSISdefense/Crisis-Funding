...
stargazer::stargazer(CBre_05A,CBre_05C,CBre_06A,Term_05A,Term_05C,Term_06A,type="text",
                     digits=2)
...
#### 06E: Duration and Office % Crisis
```{r Mode06E}
...
stargazer::stargazer(CBre_06D,CBre_06E,Term_06D,Term_06E,type="text",
                     digits=2)
...
summary_residual_compare(CBre_05G,CBre_06E,Term_05G,Term_06E)
...
stargazer::stargazer(CBre_06E,CBre_07A,Term_06E,Term_07A,type="text",
                     digits=2)
...
summary_residual_compare(CBre_06E,CBre_07A,Term_06E,Term_07A)
...
summary_residual_compare(CBre_07B,CBre_07C,Term_07B,Term_07C)
...
# Plot the model and Vehicle for SIDV
CBre_07D_SIDV_curve<-function(x, Comp,Ceil,Days,MIDV,OIDV){invlogit(
  cbind(1,Comp,Ceil,Ceil^2,Days,Days^2,x,MIDV,OIDV,
        Comp*Ceil,Days*Ceil,Days*Comp,
        Days*x,Days*MIDV,Days*OIDV,
        Comp*x,Comp*MIDV,Comp*OIDV) %*%  coef(CBre_07D))}

#Competition curves
discrete_fitted_cbre_model(crisis_smp,"SIDV") +
  stat_function(fun = CBre_07D_SIDV_curve,
                             args=list(Comp=0,Ceil=0,Days=0,
                                       MIDV=0,OIDV=0),color="blue")+
  stat_function(fun = CBre_07D_SIDV_curve,
                             args=list(Comp=2,Ceil=0,Days=0,
...
CBre_07D_MIDV_curve<-function(x, Comp,Ceil,Days,SIDV,OIDV){invlogit(
  cbind(1,Comp,Ceil,Ceil^2,Days,Days^2,SIDV,x,OIDV,
        Comp*Ceil,Days*Ceil,Days*Comp,
        Days*SIDV,Days*x,Days*OIDV,
        Comp*SIDV,Comp*x,Comp*OIDV) %*%  coef(CBre_07D))}

#Plot the model and Vehicle for MIDV
#Competition Curves
discrete_fitted_cbre_model(crisis_smp,"MIDV") +
  stat_function(fun = CBre_07D_MIDV_curve,
                             args=list(Comp=0,Ceil=0,Days=0,
                                       SIDV=0,OIDV=0),color="blue")+
  stat_function(fun = CBre_07D_MIDV_curve,
                             args=list(Comp=2,Ceil=0,Days=0,
...
CBre_07D_OIDV_curve<-function(x, Comp,Ceil,Days,SIDV,MIDV){invlogit(
  cbind(1,Comp,Ceil,Ceil^2,Days,Days^2,SIDV,MIDV,x,
        Comp*Ceil,Days*Ceil,Days*Comp,
        Days*SIDV,Days*MIDV,Days*x,
        Comp*SIDV,Comp*MIDV,Comp*x) %*%  coef(CBre_07D))}

#Plot the model and Vehicle for OIDV
#Competition curves
discrete_fitted_cbre_model(crisis_smp,"OIDV") +
  stat_function(fun = CBre_07D_OIDV_curve,
                             args=list(Comp=0,Ceil=0,Days=0,
                                       SIDV=0,MIDV=0),color="blue")+
  stat_function(fun = CBre_07D_OIDV_curve,
                             args=list(Comp=2,Ceil=0,Days=0,
...
# Plot the model and Vehicle 
CBre_08A_curve<-function(x, Comp,Ceil,Days,SIDV,MIDV,OIDV){invlogit(
  cbind(1,Comp,Ceil,Days,SIDV,MIDV,OIDV,
        Comp*Ceil,Days*Ceil,Days*Comp,
        x,
        Days*x,Days*MIDV,Days*OIDV,
        Comp*x,Comp*MIDV,Comp*OIDV) %*%  coef(CBre_08A))}
...
#Plot the fitted values vs actual results
binned_fitted_versus_cbre_residuals(CBre_08A)
...
# Plot the model and Vehicle 
CBre_08B_curve<-function(x, Comp,Ceil,Days,SIDV,MIDV,OIDV){invlogit(
  cbind(1,Comp,Ceil,Days,SIDV,MIDV,OIDV,
        Comp*Ceil,Days*Ceil,Days*Comp,
        x,
        Days*x,Days*MIDV,Days*OIDV,
        Comp*x,Comp*MIDV,Comp*OIDV,
        Days*x) %*%  coef(CBre_08B))}
...
#Plot the fitted values vs actual results
binned_fitted_versus_cbre_residuals(CBre_08B)
...
# Plot the model and Vehicle for SIDV
CBre_08C_curve<-function(x, Comp,Ceil,Days,MIDV,OIDV){invlogit(
  cbind(1,Comp,Ceil,Days,SIDV,MIDV,OIDV,
        n_Fixed,
        Comp*Ceil,Days*Ceil,Days*Comp,
...
discrete_fitted_cbre_model(crisis_smp,"n_Fixed") +
  stat_function(fun = CBre_08C_curve,
                             args=list(Comp=0,Ceil=0,Days=0,
...
#Plot the fitted values vs actual results
binned_fitted_versus_cbre_residuals(CBre_08C)
...
# Plot the model and Vehicle 
CBre_08D_curve<-function(x, Comp,Ceil,Days,SIDV,MIDV,OIDV,Fixed){invlogit(
  cbind(1,Comp,Ceil,Days,SIDV,MIDV,OIDV,
        Comp*Ceil,Days*Ceil,Days*Comp,
        Fixed,x,
        Days*x,Days*MIDV,Days*OIDV,
        Comp*x,Comp*MIDV,Comp*OIDV) %*%  coef(CBre_08D))}

#Days curves
discrete_fitted_cbre_model(crisis_smp,"n_Incent") +
  stat_function(fun = CBre_08D_curve,
                             args=list(Comp=0,Ceil=0,Days=0,
...
#Plot the fitted values vs actual results
binned_fitted_versus_cbre_residuals(CBre_08D)
...
### 08E: Incentive Fees and Fixed-Price  
...
# Plot the model and Vehicle 
CBre_08E_curve<-function(x, Comp,Ceil,Days,SIDV,MIDV,OIDV,Fixed){invlogit(
  cbind(1,Comp,Ceil,Days,SIDV,MIDV,OIDV,
        Comp*Ceil,Days*Ceil,Days*Comp,
        Fixed,x,
        Days*x,Days*MIDV,Days*OIDV,
        Comp*x,Comp*MIDV,Comp*OIDV,
        x*Fixed) %*%  coef(CBre_08E))}

#Days curves
discrete_fitted_cbre_model(crisis_smp,"SIDV") +
  stat_function(fun = CBre_08E_curve,
                             args=list(Comp=0,Ceil=0,Days=0,
                                       MIDV=0,SIDV=0,OIDV=0,
                                       Fixed=0),color="blue")+
  stat_function(fun = CBre_08E_curve,
...
#Plot the fitted values vs actual results
binned_fitted_versus_cbre_residuals(CBre_08E)

#Plot residuals versus fittedO
residuals_cbre_plot(CBre_08E)+
  labs(x="Estimated  Pr (Termination)")
...
# Plot the model and Vehicle 
CBre_08H_curve<-function(x, Comp,Ceil,Days,SIDV,MIDV,OIDV,Fixed){invlogit(
  cbind(1,Comp,Ceil,Days,SIDV,MIDV,OIDV,
        Comp*Ceil,Days*Ceil,Days*Comp,
        Fixed,x,
        Days*x,Days*MIDV,Days*OIDV,
        Comp*x,Comp*MIDV,Comp*OIDV,
        Comp*x,Days*x) %*%  coef(CBre_08H))}

#Days curves
discrete_fitted_cbre_model(crisis_smp,"SIDV") +
  stat_function(fun = CBre_08H_curve,
                             args=list(Comp=0,Ceil=0,Days=0,
                                       MIDV=0,SIDV=0,OIDV=0,
                                       Fixed=1),color="blue")+
  stat_function(fun = CBre_08H_curve,
...
#Plot the fitted values vs actual results
binned_fitted_versus_cbre_residuals(CBre_08H)

#Plot residuals versus fittedO
residuals_cbre_plot(CBre_08H)+
  labs(x="Estimated  Pr (Termination)")
