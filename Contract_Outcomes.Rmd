...
large_crisis_smp$Reach6<-factor(paste(large_crisis_smp$OffPl99,large_crisis_smp$Intl,sep="-"))
...
### 02M: Urgency + Offers
```{r Model02M}
crisis_smp$NoComp5plus<-crisis_smp$NoCompOffr
    levels(crisis_smp$NoComp5plus) <-
      list("Other No"="Other No",
           "Urgency"="Urgency",
           "1-4 offers"=c("1 offer","2-4 offers"),
           "5+ offers"="5+ offers")

  summary_discrete_plot(crisis_smp,"NoComp5plus")

#Model
CBre_02M <- glm (data=crisis_smp,
                 b_CBre ~ Crisis +NoComp5plus , 
                 family=binomial(link="logit"))
glmer_examine(CBre_02M)

Term_02M <- glm (data=crisis_smp,
                 b_Term ~ Crisis +NoComp5plus , 
                 family=binomial(link="logit"))
glmer_examine(Term_02M)


stargazer::stargazer(CBre_02E,CBre_02I,CBre_02K,CBre_02M,Term_02E,Term_02I,Term_02K,Term_02M,
                     type="text",
                     digits=2)

stargazer::stargazer(CBre_02,CBBre_02E,CBre_02I,CBre_02K,CBre_02M,Term_02B,Term_02E,Term_02I,Term_02K,Term_02M,
                     type="text",
                     digits=2)

summary_residual_compare(CBre_02E,CBre_02M,Term_02E,Term_02M,bins=3)
summary_residual_compare(CBre_02K,CBre_02M,Term_02K,Term_02M,bins=3)
summary_residual_compare(CBre_02I,CBre_02M,Term_02I,Term_02M,bins=3)
...
### 02N: Urgency + Offers
```{r Model02N}
large_crisis_smp$NoComp5plus<-large_crisis_smp$NoCompOffr
    levels(large_crisis_smp$NoComp5plus) <-
      list("Other No"="Other No",
           "Urgency"="Urgency",
           "1-4 offers"=c("1 offer","2-4 offers"),
           "5+ offers"="5+ offers")
...
#Model
CBre_02N <- glm (data=crisis_smp,
                 b_CBre ~ Crisis +NoComp5plus +
                   Crisis:NoComp5plus, 
                 family=binomial(link="logit"))
glmer_examine(CBre_02N)

CBre_02N2 <- glm (data=large_crisis_smp,
                 b_CBre ~ Crisis +NoComp5plus +
                   Crisis:NoComp5plus, 
                 family=binomial(link="logit"))
glmer_examine(CBre_02N2)


Term_02N <- glm (data=crisis_smp,
                 b_Term ~ Crisis +NoComp5plus +
                   Crisis:NoComp5plus, 
                 family=binomial(link="logit"))
glmer_examine(Term_02N)


Term_02N2 <- glm (data=crisis_smp,
                 b_Term ~ Crisis +NoComp5plus +
                   Crisis:NoComp5plus, 
                 family=binomial(link="logit"))
glmer_examine(Term_02N2)


```

VIF excludes this interaction.
...
summary_discrete_plot(crisis_smp,"UCA","NoComp")
...
CBre_05B2 <- glm (data=large_crisis_smp,
                 b_CBre ~ Crisis +NoComp +
                   b_UCA+
                   OffPl99+ c_OffCri+
                   cl_Ceil+
...
glmer_examine(CBre_05B2)

#Model
CBre_05A2 <- glm (data=large_crisis_smp,
                 b_CBre ~ Crisis +NoComp +
                   b_UCA+
                   OffPl99+ c_OffCri+
                   cl_Ceil+
...
stargazer::stargazer(CBre_05A2,CBre_05B2,Term_05A,Term_05B,type="text",
                     digits=2)

summary_residual_compare(CBre_05A2,CBre_05B2,Term_05A,Term_05B)
...
```{r Model05E}
summary_continuous_plot(large_crisis_smp,"l_Ceil","NoComp")
#Model
...
```{r Mode06F}
summary_continuous_plot(large_crisis_smp,"l_Days","NoComp")
...
stargazer::stargazer(CBre_06A,CBre_06F,type="text",
                     digits=2)


summary_residual_compare(CBre_06A,CBre_06F,bins=30)


```

VIF precludes attention for terminations. Expectations are met for ceiling breaches. 
...
stargazer::stargazer(CBre_06F,CBre_07A,Term_06F,Term_07A3,type="text",
                     digits=2)


summary_residual_compare(CBre_06F,CBre_07A,Term_06F,Term_07A3)
...
```{r Model07D}
  ...
  summary_discrete_plot(large_crisis_smp,"NoComp","Veh")
...
summary(large_crisis_smp$Term[large_crisis_smp$NoComp=="Urgency"&large_crisis_smp$Veh=="M-IDC"])


```
VIF precludes inclusion for terminations.
...
stargazer::stargazer(CBre_07D,CBre_08A,Term_07C,Term_08A,type="text",
                     digits=2)



summary_residual_compare(CBre_07D,CBre_08A,Term_07C,Term_08A,30)
...
```{r Model08F}
  summary_discrete_plot(large_crisis_smp,"n_Fixed","NoComp")
...
```{r Model10B}
  ...
  CBre_10B <- glm (data=large_crisis_smp,
                   b_CBre ~ Crisis +NoComp +
                     b_UCA+
...
c_OffCri+
  ...
  Term_10B <- glm (data=large_crisis_smp,
                   b_Term ~ Crisis +NoComp+
                     b_UCA+
                     c_OffCri+
                     Reach+
...
### 10C: Adding Crisis:NoComp
Crisis:NoComp. Expecation is that competition correlates with lower estimates of terminations and ceiling breaches for crisis subsets. Urgency is expected to estimate an even higher risk for crisis subsets.

```{r Model10C}

  CBre_10C <- glm (data=large_crisis_smp,
                   b_CBre ~ Crisis +NoComp +
                     b_UCA+
  ...
  Term_10C <- glm (data=large_crisis_smp,
                   b_Term ~ Crisis +NoComp+
                     b_UCA+
                     c_OffCri+
                     Reach+
...
```
Expectations are only partially upheld, but the results are consistently significant. 

AIC is reduced and residuals are constrained. Leaving it in is an easy call because it is key to the study, though it does prevent the consideration of numbers of offers.
...
```{r Model10D}
  ...
  CBre_10D <- glm (data=large_crisis_smp,
                   b_CBre ~ Crisis +NoComp +
                     b_UCA+
  ...
  Term_10D <- glm (data=large_crisis_smp,
                   b_Term ~ Crisis +NoComp+
                     b_UCA+
                     c_OffCri+
                     Reach+
...
# Plot the model and Vehicle 
stargazer::stargazer(CBre_10C,CBre_10D,Term_10C,Term_10D,type="text",
                        digits=2)
...
```{r Model10E}
  ...
  CBre_10E <- glm (data=large_crisis_smp,
                   b_CBre ~ Crisis +NoComp +
                     b_UCA+
  ...
  Term_10E <- glm (data=large_crisis_smp,
                   b_Term ~ Crisis +NoComp+
                     b_UCA+
                     c_OffCri+
                     Reach+
...
```
The results do not particularly align with expectations. The AIC reductions are dramatic. However, there are clear patterns introduced to the residuals for ceiling breach and the outliers are more pronounced for terminations and a larger curve seems to emerge. Removing this.
...
```{r Model10F}
  ...
  CBre_10F <- glm (data=large_crisis_smp,
                   b_CBre ~ Crisis +NoComp +
                     b_UCA+
  ...
  Term_10F <- glm (data=large_crisis_smp,
                   b_Term ~ Crisis +NoComp+
                     b_UCA+
                     c_OffCri+
                     Reach+
...
# Plot the model and Vehicle 
stargazer::stargazer(CBre_10D,CBre_10F,Term_10D,Term_10F,type="text",
                        digits=2)
summary_residual_compare(CBre_10D,CBre_10F,Term_10D,Term_10F,bins=50)

```
Expectations were not met, AIC is improved, though residuals get a bit worth. Leaving out.
...
```{r Model10G}
  ...
  CBre_10G <- glm (data=large_crisis_smp,
                   b_CBre ~ Crisis +NoComp +
                     b_UCA+
  ...
  Term_10G <- glm (data=large_crisis_smp,
                   b_Term ~ Crisis +NoComp+
                     b_UCA+
                     c_OffCri+
                     Reach+
  ...
  Term_10G2 <- glm (data=large_crisis_smp,
                   b_Term ~ Crisis +NoComp+
                     b_UCA+
                     c_OffCri+
                     Reach+
...
# Plot the model and Vehicle 
stargazer::stargazer(CBre_10D,CBre_10G,type="text",#Term_10D,Term_10G,
                        digits=2)
summary_residual_compare(CBre_10D,CBre_10G,bins=50)#Term_10D,Term_10G,

```
Does aid the model some, but runs contrary to expectation for ceiling breach and violates VIF for terminations. Leaving this out.
...
```{r Model10H}
  ...
  CBre_10H <- glm (data=large_crisis_smp,
                   b_CBre ~ Crisis +NoComp +
                     b_UCA+
...
# Plot the model and Vehicle 
stargazer::stargazer(CBre_10D,CBre_10H,type="text",
                        digits=2)
summary_residual_compare(CBre_10D,CBre_10H,bins=50)

```
Results do run in line with expectation, though the urgency result is surprising and suggests that urgency might be a larger concern for smaller contracts than for large. Comp VIF is creeping up. That said, still only 1.76. The AIC does reduce by a hundred or so, but no real improvement in residuals. Still, seems worth keeping.


### 10I:  capped_cl_Days:NoComp

Expectation: Policy guidance often encourages regular use of competition, which suggests a believe that the results wear off over time. This is disputed by others in the field. Nonetheless, the expectation is that the interaction of the absence of competition and duration negatively estimates a greater probability of terminations and ceiling breaches.

```{r Model10I}

  CBre_10I <- glm (data=large_crisis_smp,
                   b_CBre ~ Crisis +NoComp +
                     b_UCA+
  ...
  glmer_examine(CBre_10I)
    ...
    CBre_10I2 <- glm (data=large_crisis_smp,
                   b_CBre ~ Crisis +NoComp +
                     b_UCA+
                   ...
                   # NoComp:Veh,
                   family=binomial(link="logit"))
  glmer_examine(CBre_10I2)
  
# Plot the model and Vehicle 
stargazer::stargazer(CBre_10H,CBre_10I,CBre_10I2,type="text",
                        digits=2)
summary_residual_compare(CBre_10H,CBre_10I,bins=50)
summary_residual_compare(CBre_10H,CBre_10I2,bins=50)
...
save(CBre_20A,Term_20A, file="Model20A.RData")
```
...
if(!exists("CBre_20B"))
  ...
  save(CBre_20B, file="Model20B.RData")
...
save(CBre_20B,Term_20B, file="Model20B.RData")
```
...
if(!exists("CBre_20C"))
  ...
  save(CBre_20C, file="Model20C.RData")
...
stargazer::stargazer(CBre_10A,CBre_10D,CBre_20A,CBre_20B,CBre_20C,
                     Term_10A,Term_10D,Term_20A,Term_20B,Term_20C,type="text",
                        digits=2)
# summary_residual_compare(CBre_15B,CBre_20C,Term_15B,Term_20C)

save(CBre_20C,Term_20C, file="Model20C.RData")
```
...
if(!exists("CBre_20D"))
  ...
  # save(CBre_20D, file="Model20D.RData")
...
# Plot the model and Vehicle 
stargazer::stargazer(CBre_10A,CBre_10D,CBre_20A,CBre_20B,CBre_20D,
                     Term_10A,Term_10D,Term_20A,Term_20B,Term_20D,type="text",
                        digits=2)
...
summary_residual_compare(CBre_20C,CBre_20D,Term_20C,Term_20D,bins=50)
...
if(!exists("CBre_20E"))
  ...
  save(CBre_20E, file="Model20E.RData")
...
# Plot the model and Vehicle 
stargazer::stargazer(CBre_10A,CBre_10D,CBre_20A,CBre_20B,CBre_20E,
                     Term_10A,Term_10D,Term_20A,Term_20B,Term_20E,type="text",
                        digits=2)

summary_residual_compare(CBre_10A,CBre_20E,Term_10A,Term_20E,bins=50)
summary_residual_compare(CBre_20A,CBre_20E,Term_20A,Term_20E,bins=50)
summary_residual_compare(CBre_20C,CBre_20E,Term_20C,Term_20E,bins=50)
summary_residual_compare(CBre_20B,CBre_20E,Term_20B,Term_20E,bins=50)

save(CBre_20E,Term_20E, file="Model20E.RData")
```

### 20A: Product/Service/R&D and Platform
...
load("model20A.rdata")  
  ...
  glmer_examine(Term_20A)
# Plot the model and Vehicle 
stargazer::stargazer(CBre_15B,CBre_20A,Term_15B,Term_20A,type="text",
                        digits=2)
summary_residual_compare(CBre_15B,CBre_20A,Term_15B,Term_20A)
