...
# Plot the model and Vehicle 
stargazer::stargazer(CBre_21A,CBre_21D,type="text",#Term_20A,#Term_20C
                        digits=2)

summary_residual_compare(CBre_21A,CBre_21D,Term_21A,Term_21D,bins=50)
```



### 21E: NoComOffr2:Ceil and NoCompOffr:UCA
```{r Model21E}
# summary(large_crisis_smp$ServCommCons)
# summary(large_crisis_smp$CPSA)
...
if(!exists("CBre_21D"))
  ...
  save(CBre_21D, file="Output//Model21D_CBre.RData")
...
if(!exists("CBre_21E"))
  ...
  save(CBre_21E, file="Output//Model21E_CBre.RData")
