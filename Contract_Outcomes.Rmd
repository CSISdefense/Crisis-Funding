...
CBre_03B <- glm (data=crisis_smp,
                 b_CBre ~ ARRA + Dis + OCO +cb_Comp + b_Urg +
                   ...
                   cb_Comp:ARRA + cb_Comp:Dis + cb_Comp:OCO+
                   b_Urg:ARRA + b_Urg:Dis + b_Urg:OCO+
                   b_UCA:ARRA + b_UCA:Dis + b_UCA:OCO , 
                 family=binomial(link="logit"))
display(CBre_03B)
...
#Ceiling Breaches
gridExtra::grid.arrange(freq_continuous_cbre_plot(crisis_smp,"AvgPlaceOCOcrisisScore"),
             binned_percent_cbre_plot(crisis_smp,"AvgPlaceOCOcrisisScore"))


#Terminations
gridExtra::grid.arrange(freq_continuous_term_plot(crisis_smp,"AvgPlaceOCOcrisisScore"),
                        binned_percent_term_plot(crisis_smp,"AvgPlaceOCOcrisisScore"))
