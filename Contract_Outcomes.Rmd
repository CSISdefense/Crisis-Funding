...
load("model12B.rdata")  
  ...
  stargazer::stargazer(CBre_11B,CBre_12B,Term_11B,Term_12B,type="text",
                       digits=2)
...
load("Model12C.RData") #Only have CBre at the moment
  ...
  Term_15C <- glmer (data=large_crisis_smp,
                   b_Term ~ Crisis + 
                     b_NoComp + 
                     b_UCA + 
                     Reach + c_OffCri + 
...
summary_residual_compare(CBre_12A,CBre_15C,Term_12A,Term_15C,20)
save(CBre_15C, Term_15C,file="Model12C.RData")
```
