...
summary_continuous_plot(crisis_smp,"sqrt_OffCri",bins=50)
...
summary_discrete_plot(crisis_smp,"l_Ceil","UCA")
summary_continuous_plot(crisis_smp,"l_Ceil","sqrt_OffCri")

crisis_smp$sqrt_OffCri
#Create the model
