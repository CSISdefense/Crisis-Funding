...
# Dummies that will be covered by Multilevel
  ...
  Term_20A <- glmer (data=large_crisis_smp,
                   b_Term ~ Crisis +NoComp+
                    ...
                    cl_Ceil+
                     ...
                     # Crisis:Is.Defense+
                     # (1 | Simple) +
                     (1 | CrisisProductOrServiceArea/ProdServ) + (1 | Customer/Office)+ (1 | PlaceCountryISO3), 
                   family=binomial(link="logit"))
  glmer_examine(Term_20A)
# Plot the model and Vehicle 
stargazer::stargazer(CBre_10A,CBre_10D,CBre_20A,Term_10A,Term_10D,Term_20A,type="text",
                        digits=2)
...
# Plot the model and Vehicle 
stargazer::stargazer(CBre_10A,CBre_10D,CBre_20B,Term_10A,Term_10D,Term_20B,type="text",
                        digits=2)
# summary_residual_compare(CBre_15B,CBre_20B,Term_15B,Term_20B)
...
# Plot the model and Vehicle 
stargazer::stargazer(CBre_10A,CBre_10D,CBre_20C,Term_10A,Term_10D,Term_20C,type="text",
                        digits=2)
