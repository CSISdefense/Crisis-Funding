...
```{r Model10C}
crisis_all$NoCompOffr2<-factor(crisis_all$NoCompOffr,levels=c(  "2-4 offers" ,"Other No",   "Urgency" ,   "1 offer"  ,"5+ offers" ))
fed_1m$NoCompOffr2<-factor(fed_1m$NoCompOffr,levels=c(  "2-4 offers" ,"Other No",   "Urgency" ,   "1 offer"  ,"5+ offers" ))
...
### 21A: NoComOffr2 and OffCri for terminations
```{r Model21A}
# summary(large_crisis_smp$ServCommCons)
# summary(large_crisis_smp$CPSA)
...
stargazer::stargazer(CBre_21A,CBre_22A,
                     Term_21A,Term_22A,type="text",#Term_20A,#Term_20C
                        digits=2)
...
<<<<<<< HEAD
  ...
  save(Term_22C, file="Output//Model22C_term.RData")#CBre_22C,
=======
                   verbose=1,
     control = glmerControl(optimizer = "optimx", calc.derivs = FALSE,
     optCtrl = list(method = "nlminb", starttests = FALSE, kkt = FALSE)))
...
stargazer::stargazer(CBre_21A,CBre_22C,
                     Term_21A,Term_22C,type="text",#Term_20A,#Term_20C
                        digits=2)
...
### 22D: Minimal Interactions
```{r Model22D}
# summary(large_crisis_smp$ServCommCons)
# summary(large_crisis_smp$CPSA)

load("Output//Model22D.rdata")
...
if(!exists("Term_22D"))
  ...
  save(Term_22D, file="Output//Model22D_term.RData")#CBre_22D,
# Plot the model and Vehicle 
stargazer::stargazer(CBre_10A,CBre_10H,CBre_20B,CBre_20B,CBre_20G,#CBre_20A,
                     Term_10A,Term_10D,Term_20B,Term_20G,type="text",#Term_20A,#Term_20C
                        digits=2)
...
stargazer::stargazer(CBre_21A,CBre_22D,
                     Term_21A,Term_22D,type="text",#Term_20A,#Term_20C
                        digits=2)
