...
### 10A: Defense/Civilian
Expectation: DoD is noteworthy for its technically complex major projects and for operating in conflict environment. Defense constracts positively estimate the probability of ceiling breaches and terminations.
```{r Model10A}
