...
# large_crisis_with_na$OffCri<-large_crisis_with_na$CrisisPercent
# large_crisis_with_na$ProductOrServiceCode<-as.character(large_crisis_with_na$ProdServ)
#   large_crisis_with_na<-csis360::read_and_join( large_crisis_with_na,
#                                "ProductOrServiceCodes.csv",                             path="https://raw.githubusercontent.com/CSISdefense/Lookup-Tables/master/",
#                                directory="",
#                                by="ProductOrServiceCode",
#                                add_var=c("Simple",
...
#                                          "ProductOrServiceArea"),
#                                new_var_checked=FALSE)
# large_crisis_with_na$ProductServiceOrRnDarea<-factor(large_crisis_with_na$ProductServiceOrRnDarea)
# large_crisis_with_na$ProductOrServiceArea<-factor(large_crisis_with_na$ProductOrServiceArea)
# summary(large_crisis_with_na$ProductServiceOrRnDarea)
# summary(large_crisis_with_na$ProductOrServiceArea)
# # summary(large_crisis_with_na$b_Comp )
# # summary(large_crisis_with_na$n_Comp )
# # summary(large_crisis_with_na$Comp )
# # summary(large_crisis_with_na$CompOffr )
# # summary(large_crisis_with_na$EffComp )
# 
# large_crisis_with_na$b_NoComp<-!large_crisis_with_na$b_Comp
# 
# complete<-!is.na(large_crisis_with_na$b_Term)&
#   !is.na(large_crisis_with_na$b_CBre)&
#   !is.na(large_crisis_with_na$b_Comp)&
#   !is.na(large_crisis_with_na$b_Urg)&
#   !is.na(large_crisis_with_na$l_Ceil)&
#   !is.na(large_crisis_with_na$l_Days)&
#   !is.na(large_crisis_with_na$Veh) &
#   !is.na(large_crisis_with_na$n_Fixed)&
#   !is.na(large_crisis_with_na$b_Intl)&
#   !is.na(large_crisis_with_na$b_UCA)&
#   !is.na(large_crisis_with_na$ProdServ)&
#   !is.na(large_crisis_with_na$Crisis)&
#   !is.na(large_crisis_with_na$Office)&
# !is.na(large_crisis_with_na$OffCri)&
#   !is.na(large_crisis_with_na$OffIntl)&
#   !is.na(large_crisis_with_na$Is.Defense)&
#   !is.na(large_crisis_with_na$ProductOrServiceArea)
#   # !is.na(large_crisis_with_na$cl_HHI_lag1)
# large_crisis_smp<-large_crisis_with_na[complete,]
...
```
The results do not aligne with expectations, with the exception of terminations for contracts between the 2,500 and 150,000 for terminations. For these dummy variables to work, they apparently must be considered in interaction with the ceiling. This in essence would allow for a different slope for ceiling in each of the three categories.
...
```{r Model13B}
    summary_discrete_plot(crisis_smp,"Crisis","Is.Defense")
...
#Create the model
  ...
  stargazer::stargazer(CBre_12A,CBre_13C,Term_12A,Term_13C,type="text",
                       digits=2)
  debug(summary_residual_compare)
summary_residual_compare(CBre_12A,CBre_13C,Term_12A,Term_13C,bins=20)
...
#Create the model
  ...
  stargazer::stargazer(CBre_12A,CBre_14A,Term_12A,Term_14A,type="text",
                       digits=2)
summary_residual_compare(CBre_12A,CBre_14A,Term_12A,Term_14A,bins=20)

  
```
VIF proves off the charts. This interaction will be drpopped.

### 14B: Fixed-Price and Product or Service Area

#Multi-Level Model
### 15A: Product/Service/R&D and Platform
```{r Model15A}
...
load("model15A.rdata")  
  ...
  # CBre_15A <- glmer (data=crisis_smp,
  #                   b_CBre ~ Crisis + NoComp +
  #                    b_UCA +
  #                    Reach + c_OffCri + 
  #                    cl_Ceil + 
...
display(CBre_15A)
  ...
  # Term_15A <- glmer(data=crisis_smp,
  #                  b_Term ~ Crisis +
  #                    b_NoComp +
  #                    b_UCA +
  #                    Reach + c_OffCri +
...
stargazer::stargazer(CBre_11B,CBre_15A,Term_11B,Term_15A,type="text",
                        digits=2)
summary_residual_compare(CBre_11B,CBre_15A,Term_11B,Term_15A)

# save(CBre_15A,Term_15A, file="Model15A.RData")
```
...
load("model15B.rdata")  
  ...
  # CBre_15B <- glmer (data=crisis_smp,
  #                  b_CBre ~ Crisis + NoComp + 
  #                    b_UCA +
  #                    Reach + c_OffCri + 
  #                    cl_Ceil + 
  ...
  display(CBre_15B)
  # 
  # Term_15B <- glmer (data=crisis_smp,
  #                  b_Term ~ Crisis + 
  #                    b_NoComp + 
  #                    b_UCA + 
  #                    Reach + c_OffCri + 
...
stargazer::stargazer(CBre_11B,CBre_15A,CBre_15B,Term_11B,Term_15A,Term_15B,type="text",
                        digits=2)

summary_residual_compare(CBre_15A,CBre_15B,Term_15A,Term_15B)
# save(CBre_15B,Term_15B, file="Model15B.RData")
...
### 15C: Interactions
```{r Model15C}
load("Model15C.RData") #Only have CBre at the moment

  # CBre_15C <- glmer (data=crisis_smp,
  #                  b_CBre ~ Crisis + NoComp + 
  #                    b_UCA +
  #                    Reach + c_OffCri + 
  #                    cl_Ceil + 
  ...
  #                  family=binomial(link="logit"))
  # display(Term_15C)
  stargazer::stargazer(CBre_11B,CBre_15A,CBre_15B,CBre_15C,Term_11B,Term_15A,Term_15B,type="text",
                        digits=2)

summary_residual_compare(CBre_15B,CBre_15C,Term_15A,Term_15B)
# save(CBre_15C, file="Model15C.RData")
```
