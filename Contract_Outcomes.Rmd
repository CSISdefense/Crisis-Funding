...
debug(sumamry_discrete_plot)
sumamry_discrete_plot(crisis_smp,"CrisisPercent",bins=50)
...
###Model 05E: Ceiling and Duration
...
###Model 05H: Duration and Office % Crisis
```{r Mode05H}
...
###Model 06A: Single-Award, Multi-Award, and Other Indefinite Delivery Vehicles
...
The next step is to check the intersections with Crisis.


###Model 06B: Vehicle and Duration
```{r Model06B}
...
#Plot the fitted values vs actual results
binned_fitted_versus_cbre_residuals(CBre_06B)
...
###Model 06C: Vehicle and Competition
...
#Plot the fitted values vs actual results
binned_fitted_versus_cbre_residuals(CBre_06C)

#Plot residuals versus fittedO
residuals_cbre_plot(CBre_06C)+
  labs(x="Estimated  Pr (Termination)")
...
###Model 06D: Vehicle and Contract Ceiling
```{r Model06D}
...
CBre_06D_SIDV_curve<-function(x, Comp,Ceil,Days,MIDV,OIDV){invlogit(
  cbind(1,Comp,Ceil,Ceil^2,Days,Days^2,x,MIDV,OIDV,
        ...
        Ceil*x,Ceil*MIDV,Ceil*OIDV) %*%  coef(CBre_06D))}
...
CBre_06D_MIDV_curve<-function(x, Comp,Ceil,Days,SIDV,OIDV){invlogit(
  cbind(1,Comp,Ceil,Ceil^2,Days,Days^2,SIDV,x,OIDV,
        ...
        Ceil*SIDV,Ceil*x,Ceil*OIDV) %*%  coef(CBre_06D))}
...
CBre_06D_OIDV_curve<-function(x, Comp,Ceil,Days,SIDV,MIDV){invlogit(
  cbind(1,Comp,Ceil,Ceil^2,Days,Days^2,SIDV,MIDV,x,
        ...
        Ceil*SIDV,Ceil*MIDV,Ceil*x) %*%  coef(CBre_06D))}
...
#Plot the fitted values vs actual results
binned_fitted_versus_cbre_residuals(CBre_06D)

#Plot residuals versus fittedO
residuals_cbre_plot(CBre_06D)+
  labs(x="Estimated  Pr (Termination)")
...
###Model 06E: Testing the removal of Ceiling^2 
...
# Plot the model and Vehicle for SIDV
CBre_06E_SIDV_curve<-function(x, Comp,Days,SIDV,MIDV,OIDV){invlogit(
  cbind(1,Comp,x,Days,Days^2,SIDV,MIDV,OIDV,
        Comp*x,Days*x,Days*Comp,
        Days*SIDV,Days*MIDV,Days*OIDV,
        Comp*SIDV,Comp*MIDV,Comp*OIDV) %*%  coef(CBre_06E))}

#Competition curves
discrete_fitted_cbre_model(crisis_smp,"cl_Ceil") +
  stat_function(fun = CBre_06E_SIDV_curve,
...
#Plot the fitted values vs actual results
binned_fitted_versus_cbre_residuals(CBre_06E)

#Plot residuals versus fitted
residuals_cbre_plot(CBre_06E)+
  labs(x="Estimated  Pr (Termination)")

residuals_cbre_plot(CBre_06D,"cl_Ceil")+
  labs(x="Centered Log(Ceiling)")


residuals_cbre_plot(CBre_06E,"cl_Ceil")+
  labs(x="Centered Log(Ceiling)")
...
###Model 06F: Testing the removal of Duration^2 
...
# Plot the model and Vehicle for SIDV
CBre_06F_SIDV_curve<-function(x, Comp,Days,SIDV,MIDV,OIDV){invlogit(
  cbind(1,Comp,x,Days,Days^2,SIDV,MIDV,OIDV,
        Comp*x,Days*x,Days*Comp,
        Days*SIDV,Days*MIDV,Days*OIDV,
        Comp*SIDV,Comp*MIDV,Comp*OIDV) %*%  coef(CBre_06F))}

#Competition curves
discrete_fitted_cbre_model(crisis_smp,"cl_Ceil") +
  stat_function(fun = CBre_06F_SIDV_curve,
                             args=list(Comp=0,Days=0,
                                       MIDV=0,OIDV=0,SIDV=0),color="blue")+
  stat_function(fun = CBre_06F_SIDV_curve,
                             args=list(Comp=2,Days=0,
...
#Plot the fitted values vs actual results
binned_fitted_versus_cbre_residuals(CBre_06F)
...
#Plot residuals versus fitted
residuals_cbre_plot(CBre_06F)+
  labs(x="Estimated  Pr (Termination)")

# residuals_cbre_plot(CBre_06E,"cl_Days")+
  # labs(x="Centered Log(Duration)")


# residuals_cbre_plot(CBre_06F,"cl_Days")+
  # labs(x="Centered Log(Duration)")
```
