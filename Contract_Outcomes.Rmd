...
# #Ceiling Breaches
# gridExtra::grid.arrange(freq_continuous_cbre_plot(crisis_smp,"OffIntl","Crisis"),
#              binned_percent_cbre_plot(crisis_smp,"OffIntl","Crisis"))
# 
# 
# #Terminations
# gridExtra::grid.arrange(freq_continuous_term_plot(crisis_smp,"OffIntl","Crisis"),
#                         binned_percent_term_plot(crisis_smp,"OffIntl","Crisis"))
...
CBre_05B <- glm (data=crisis_smp,
                 b_CBre ~ Crisis +NoComp +
                  ...
                  NoComp:Crisis+
                   ...
                   b_UCA:Crisis+OffPl99:Crisis+NoComp:OffPl99+
                   cl_Ceil:Crisis, 
                 family=binomial(link="logit"))
display(CBre_05B)
...
summary_residual_compare(CBre_06C,CBre_06D,Term_06C,Term_06D,20)
