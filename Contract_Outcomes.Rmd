...
#Plot the fitted values vs actual results
gridExtra::grid.arrange(binned_fitted_versus_cbre_residuals(CBre_05B),
                        binned_fitted_versus_term_residuals(Term_05B))



#Plot residuals versus fitted
gridExtra::grid.arrange(residuals_cbre_plot(CBre_05B,bins=20)+
  labs(x="Estimated  Pr (Ceiling Breach)"),
                        residuals_term_plot(Term_05B,bins=20)+
  labs(x="Estimated  Pr (Termination)"))

gridExtra::grid.arrange(residuals_cbre_plot(CBre_05B,"c_OffCri",bins=10)+
  labs(x="Office Crisis %"),
                        residuals_term_plot(Term_05B,"c_OffCri",bins=10)+
  labs(x="Office Crisis %"))


#Plot residuals versus ceiling
gridExtra::grid.arrange(residuals_cbre_plot(CBre_05B,"cl_Ceil",bins=20)+
  labs(x="Centered Log(Ceiling)"),
                        residuals_term_plot(Term_05B,"cl_Ceil",bins=20)+
  labs(x="Centered Log(Ceiling)"))
...
###Model 05C: Cost Ceiling and Crisis
...
#Plot residuals versus fitted
gridExtra::grid.arrange(residuals_cbre_plot(CBre_05C,bins=20)+
  labs(x="Estimated  Pr (Ceiling Breach)"),
                        residuals_term_plot(Term_05C,bins=20)+
  labs(x="Estimated  Pr (Termination)"))

gridExtra::grid.arrange(residuals_cbre_plot(CBre_05C,"c_OffCri",bins=10)+
  labs(x="Office Crisis %"),
                        residuals_term_plot(Term_05C,"c_OffCri",bins=10)+
  labs(x="Office Crisis %"))


#Plot residuals versus ceiling
gridExtra::grid.arrange(residuals_cbre_plot(CBre_05C,"cl_Ceil",bins=20)+
  labs(x="Centered Log(Ceiling)"),
                        residuals_term_plot(Term_05C,"cl_Ceil",bins=20)+
  labs(x="Centered Log(Ceiling)"))

```
Low ceiling UCAs are associated with higher risk of ceiling breaches than high ceiling UCAs, though UCAs in general remain associated with high rates of breaches. This relationship is not signicant for terminations. Leaving it off on the Terminations side as it doesn't have a net contribution to reducing model deviance.
...
stargazer::stargazer(CBre_05D,Term_05D,type="text",
                     digits=2)
...
#Plot residuals versus fitted
gridExtra::grid.arrange(residuals_cbre_plot(CBre_05D,bins=20)+
  labs(x="Estimated  Pr (Ceiling Breach)"),
                        residuals_term_plot(Term_05D,bins=20)+
  labs(x="Estimated  Pr (Termination)"))

gridExtra::grid.arrange(residuals_cbre_plot(CBre_05D,"c_OffCri",bins=10)+
  labs(x="Office Crisis %"),
                        residuals_term_plot(Term_05D,"c_OffCri",bins=10)+
  labs(x="Office Crisis %"))


#Plot residuals versus ceiling
gridExtra::grid.arrange(residuals_cbre_plot(CBre_05D,"cl_Ceil",bins=20)+
  labs(x="Centered Log(Ceiling)"),
                        residuals_term_plot(Term_05D,"cl_Ceil",bins=20)+
  labs(x="Centered Log(Ceiling)"))



#Plot residuals versus Days
gridExtra::grid.arrange(residuals_cbre_plot(CBre_05D,"cl_Days",bins=10)+
  labs(x="Centered Log(Days)"),
                        residuals_term_plot(Term_05D,"cl_Days",bins=10)+
  labs(x="Centered Log(Days)"))
```
