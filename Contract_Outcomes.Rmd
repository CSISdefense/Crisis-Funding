...
CBre_02I <- glm (data=crisis_smp,
                 b_CBre ~ Crisis +UrgComp +
                   cb_Comp:Crisis, 
                 family=binomial(link="logit"))
display(CBre_02I)

Term_02I <- glm (data=crisis_smp,
                 b_Term ~ Crisis +UrgComp +
                   cb_Comp:Crisis, 
                 family=binomial(link="logit"))
display(Term_02I)
...
summary(crisis_smp$OffPl99)
  ...
  crisis_smp$OffPl99<-factor(crisis_smp$OffPl99,
                           c("Mixed",
                           "US99",
                           "IRQ-AFG"))
...
crisis_smp$OffPl75<-factor(crisis_smp$OffPl75,
                           c("Mixed",
                           "US75",
                           "IRQ-AFG"))
...
summary_residual_compare(CBre_04G,CBre_04H,Term_04G,Term_04H)
```
...
gridExtra::grid.arrange(freq_discrete_cbre_plot(crisis_smp,"OffPl95","UCA"),
                        discrete_percent_cbre_plot(crisis_smp,"OffPl95","UCA"))
                        
#Terminations
gridExtra::grid.arrange(freq_discrete_term_plot(crisis_smp,"OffPl95","UCA"),
                        discrete_percent_term_plot(crisis_smp,"OffPl95","UCA"))
...
```{r Model06D}
  ...
  summary_discrete_plot(crisis_smp,"UrgComp","Veh")
