...
```
The expectation was upheld. However, the VIF does exceed 2 for the new interaction for ceiling breaches and also for No Competition. For ceiling breaches, removing both Crisis:NoCompOffr and sadly Crisis:cl_Ceil. 
...
```
The results are strong but contrary to the expectation.
...
```{r Model10J}
  ...
  CBre_10J <- glm (data=large_crisis_smp,
                   b_CBre ~ Crisis +NoCompOffr +
                     b_UCA+
  ...
  CBre_10J2 <- glm (data=large_crisis_smp,
                   b_CBre ~ Crisis +NoCompOffr +
                     b_UCA+
