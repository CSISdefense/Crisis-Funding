...
!is.na(data$OffCri)&
  ...
  !is.na(data$ProductOrServiceArea)
...
load("Model16F.RData") #Only have CBre at the moment
    ...
    CBre_16F3 <- glmer (data=large_crisis_smp,
                     b_CBre ~ Crisis + NoComp +
                       b_UCA +
                       Reach + 
                       c_OffCri +
  ...
  #                  family=binomial(link="logit"))
  # display(Term_16C)
  stargazer::stargazer(CBre_16C,CBre_16E,CBre_16F3,CBre_16F3,type="text",
                        digits=2)

  
  
    CBre_16F7 <- glmer (data=large_crisis_smp,
                     b_CBre ~ Crisis + NoComp +
                       b_UCA +
                       Reach + 
                       c_OffCri +
    ...
    CBre_16F8 <- glmer (data=large_crisis_smp,
                     b_CBre ~ Crisis + NoComp +
                       b_UCA +
                       Reach + 
                       c_OffCri +
    ...
    CBre_16F9<- glmer (data=large_crisis_smp,
                     b_CBre ~ Crisis + NoComp +
                       b_UCA +
                       Reach + 
                       c_OffCri +
...
summary_residual_compare(CBre_16C,CBre_16F7,Term_16C,Term_16C)
summary_residual_compare(CBre_16C,CBre_16F8,Term_16C,Term_16C)
coef(CBre_16F7)
save(CBre_16F2,CBre_16F3,CBre_16F4,CBre_16F5,CBre_16F6,CBre_16F7,CBre_16F8, file="Model16F.RData")


```  
16F 2
Model failed to converge with max|grad| = 0.20068 (tol = 0.001, component 1)

16F3 failure to converge in 10000 evaluationsModel failed to converge with max|grad| = 0.0173215 (tol = 0.001, component 1)

16F4 
Model failed to converge with max|grad| = 0.00380252 (tol = 0.001, component 1)

16F5
Model failed to converge with max|grad| = 0.00894279 (tol = 0.001, component 1

VIF threshold exceeded for reach, so removing Reach:Crisis is a straightforward next step.

Model failed to converge with max|grad| = 0.01341 (tol = 0.001, component 1)

GOing mroe detailed proved useful for 16F7

Model failed to converge with max|grad| = 0.00400832 (tol = 0.001, component 1)

16F8
Model failed to converge with max|grad| = 0.00361024 (tol = 0.001, component 1)

16F9
failure to converge in 10000 evaluationsModel failed to converge with max|grad| = 0.00429031 (tol = 0.001, component 1)
