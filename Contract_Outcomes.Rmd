...
binned_percent_plot(crisis_smp,"l_Ceil",bins=100)+geom_vline(xintercept=c(log(10000),log(15000)))
binned_percent_plot(crisis_smp,"l_Ceil","Veh")+geom_vline(xintercept=c(log(10000),log(15000)))

binned_percent_plot(subset(crisis_smp,Veh!="M-IDC"),"l_Ceil",bins=100)+geom_vline(xintercept=c(log(10000),log(15000)))
binned_percent_plot(subset(crisis_smp,Veh=="M-IDC"),"l_Ceil",bins=100)+geom_vline(xintercept=c(log(10000),log(15000)))
...
### 13B: Defense and Product or Service Area
...
summary_residual_compare(CBre_12A,CBre_13B,Term_12A,Term_13B,bins=20)
  ...
  stargazer::stargazer(CBre_12A,CBre_13B2,Term_12A,Term_13B2,type="text",
                       digits=2)
  summary_residual_compare(CBre_12A,CBre_13B2,Term_12A,Term_13B2,bins=20)
