...
### 09A: Any International and Office Place
Because office level and contract level location are highly correlated (specifically the Intl state), they likely both can't be included in the model. This step will double check.
```{r Model09A}
corrdisp<-Hmisc::rcorr(as.matrix(cbind(subset(crisis_smp, select=c(b_UCA,
                                                             c_OffCri,cl_Ceil,
                                               cl_Days,n_Fixed,b_Intl)),
...
### 09B: Combined International Office and Contract
...
corrdisp[[1]]#[,1:9]
  ...
  stargazer::stargazer(CBre_08B,CBre_09B,Term_08A,Term_09B,type="text",
                       digits=2)
