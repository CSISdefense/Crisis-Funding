...
crisis_smp$Crisis<-factor(crisis_smp$Crisis,c("Other","ARRA","Dis","OCO"))
...
#Ceiling Breaches
gridExtra::grid.arrange(freq_continuous_cbre_plot(crisis_smp,"AvgPlaceOCOcrisisScore",bins=50),
        binned_percent_cbre_plot(crisis_smp,"AvgPlaceOCOcrisisScore",bins=50))


#Terminations
gridExtra::grid.arrange(freq_continuous_term_plot(crisis_smp,"AvgPlaceOCOcrisisScore",bins=50),
        binned_percent_term_plot(crisis_smp,"AvgPlaceOCOcrisisScore",bins=50))
...
crisis_smp$OffPlace<-crisis_smp$AvgPlaceOCOcrisisScore+1
crisis_smp$OffPlace[crisis_smp$OffPlace<0]<-0
crisis_smp$OffPlace[crisis_smp$OffPlace>4]<-4
crisis_smp$sqrt_OffPlace<-sqrt(crisis_smp$OffPlace)
...
### Model 04E: Office Place, 4-category
...
#Ceiling Breaches
gridExtra::grid.arrange(freq_continuous_cbre_plot(crisis_smp,"sqrt_OffCri"),
             binned_percent_cbre_plot(crisis_smp,"sqrt_OffCri")+geom_vline(xintercept=c(0.1,0.16,0.25)))


#Terminations
gridExtra::grid.arrange(freq_continuous_term_plot(crisis_smp,"sqrt_OffCri"),
                        binned_percent_term_plot(crisis_smp,"sqrt_OffCri")+geom_vline(xintercept=c(0.1,0.16,0.25)))



crisis_smp$sqrt_OffCri<-sqrt(crisis_smp$CrisisPercent)
...
gridExtra::grid.arrange(residuals_cbre_plot(CBre_04H,"sqrt_OffCri",bins=15)+
  labs(x="Centered Log(Ceiling)"),
                        residuals_term_plot(Term_04H,"sqrt_OffCri",bins=15)+
  labs(x="Centered Log(Ceiling)"))
...
#Ceiling Breaches
gridExtra::grid.arrange(freq_continuous_cbre_plot(crisis_smp,"sqrt_OffCri"),
             binned_percent_cbre_plot(crisis_smp,"sqrt_OffCri"))


#Terminations
gridExtra::grid.arrange(freq_continuous_term_plot(crisis_smp,"sqrt_OffCri"),
                        binned_percent_term_plot(crisis_smp,"sqrt_OffCri"))
...
gridExtra::grid.arrange(residuals_cbre_plot(CBre_04I,"sqrt_OffCri",bins=10)+
  labs(x="Centered Log(Ceiling)"),
                        residuals_term_plot(Term_04I,"sqrt_OffCri",bins=10)+
  labs(x="Centered Log(Ceiling)"))
...
#Plot residuals versus CrisisPercent
gridExtra::grid.arrange(residuals_cbre_plot(CBre_04J,"sqrt_OffCri",bins=10)+
  labs(x="Centered Log(Ceiling)"),
                        residuals_term_plot(Term_04J,"sqrt_OffCri",bins=10)+
  labs(x="Centered Log(Ceiling)"))
...
#Ceiling Breaches
gridExtra::grid.arrange(freq_continuous_cbre_plot(crisis_smp,"sqrt_OffCri","Crisis"),
             binned_percent_cbre_plot(crisis_smp,"sqrt_OffCri","Crisis"))


#Terminations
gridExtra::grid.arrange(freq_continuous_term_plot(crisis_smp,"sqrt_OffCri","Crisis"),
                        binned_percent_term_plot(crisis_smp,"sqrt_OffCri","Crisis"))
...
#Plot residuals versus CrisisPercent
gridExtra::grid.arrange(residuals_cbre_plot(CBre_04K,"sqrt_OffCri",bins=10)+
  labs(x="Office Crisis %"),
                        residuals_term_plot(Term_04K,"sqrt_OffCri",bins=10)+
  labs(x="Office Crisis %"))
...
#Ceiling Breaches
gridExtra::grid.arrange(freq_continuous_cbre_plot(crisis_smp,"sqrt_OffCri","OffPlaceCat4"),
             binned_percent_cbre_plot(crisis_smp,"sqrt_OffCri","OffPlaceCat4"))


#Terminations
gridExtra::grid.arrange(freq_continuous_term_plot(crisis_smp,"sqrt_OffCri","OffPlaceCat4"),
                        binned_percent_term_plot(crisis_smp,"sqrt_OffCri","OffPlaceCat4"))
...
#Plot residuals versus CrisisPercent
gridExtra::grid.arrange(residuals_cbre_plot(CBre_04L,"sqrt_OffCri",bins=10)+
  labs(x="Centered Log(Ceiling)"),
                        residuals_term_plot(Term_04L,"sqrt_OffCri",bins=10)+
  labs(x="Centered Log(Ceiling)"))
...
#Ceiling Breaches
gridExtra::grid.arrange(freq_continuous_cbre_plot(crisis_smp,"l_Ceil"),
             binned_percent_cbre_plot(crisis_smp,"l_Ceil"))


#Terminations
gridExtra::grid.arrange(freq_continuous_term_plot(crisis_smp,"l_Ceil"),
                        binned_percent_term_plot(crisis_smp,"l_Ceil"))
...
gridExtra::grid.arrange(residuals_cbre_plot(CBre_05A,"sqrt_OffCri",bins=10)+
  labs(x="Office Crisis %"),
                        residuals_term_plot(Term_05A,"sqrt_OffCri",bins=10)+
  labs(x="Office Crisis %"))
...
Contract ceiling has a significant relationship, though the residuals show a possible non-linear patterns. This is most remarkable in the positive centered values between 0 and 1 This suggests that addding the log(Ceil)^2 might better capture the underlying data. 



###Model 05B: Cost Ceiling Squared
...
#Ceiling Breaches
gridExtra::grid.arrange(freq_continuous_cbre_plot(crisis_smp,"lsqr_Ceil"),
             binned_percent_cbre_plot(crisis_smp,"lsqr_Ceil"))


#Terminations
gridExtra::grid.arrange(freq_continuous_term_plot(crisis_smp,"lsqr_Ceil"),
                        binned_percent_term_plot(crisis_smp,"lsqr_Ceil"))
...
CBre_05D <- glm (data=crisis_smp,
                 b_CBre ~ Crisis + n_Comp + cl_Ceil + clsqr_Ceil, family=binomial(link="logit"))
display(CBre_05D)

#Plot the fitted model plot
CBre_05D_curve<-function(x, Comp){invlogit(cbind(1,Comp,x, x^2) %*%  coef(CBre_05D))}
...
#Plot the fitted values vs actual results
binned_fitted_versus_cbre_residuals(CBre_05D)

#Plot residuals versus fitted
residuals_cbre_plot(CBre_05D)+
  labs(x="Estimated  Pr (Termination)")

residuals_cbre_plot(CBre_05D,"cl_Ceil")+
  labs(x="Centered Log(Ceiling)")
...
###Model 05C: Cost Ceiling and Competition
...
CBre_05E <- glm (data=crisis_smp,
                 b_CBre ~ Crisis + n_Comp + cl_Ceil + clsqr_Ceil + n_Comp:cl_Ceil, family=binomial(link="logit"))
display(CBre_05E)
...
residuals_cbre_plot(CBre_05E,"cl_Ceil")+
  labs(x="Centered Log(Ceiling)")
```
