...
load("model16A.rdata")  
  CBre_16A <- glmer (data=large_crisis_smp,
                   b_CBre ~ Crisis +NoComp +
                     b_UCA+
                     Reach+ 
                     cl_Ceil+
                   ...
                   NoComp:Veh+
                     ...
                     (1| PSA), 
                   family=binomial(link="logit"))
  glmer_examine(CBre_16A)
  
  Term_16A <- glmer (data=large_crisis_smp,
                   b_Term ~ Crisis +NoComp+
                     b_UCA+
                     c_OffCri+
                     Reach+ 
...
#     cl_Ceil + capped_cl_Days + Veh + n_Fixed + Is.Defense + capped_cl_Days:NoComp + 
