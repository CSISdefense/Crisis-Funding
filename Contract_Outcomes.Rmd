...
crisis_smp$CPSA<-as.character(crisis_smp$CrisisProductOrServiceArea)
crisis_smp$CPSA<-factor(gsub(" & ","+",crisis_smp$CPSA))
...
# save(CBre_16C, file="Model16C.RData")
```
...
### 16D: Product/Service/R&D and Platform
...
stargazer::stargazer(CBre_11B,CBre_16D,Term_11B,Term_16D,type="text",
                        digits=2)
summary_residual_compare(CBre_11B,CBre_16D,Term_11B,Term_16D)

# save(CBre_16A,Term_16A, file="Model16A.RData")
```

### 16E: Product/Service/R&D and Platform
...
stargazer::stargazer(CBre_15B,CBre_16E,Term_15B,Term_16E,type="text",
                        digits=2)
