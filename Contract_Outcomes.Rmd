...
if(!exists("CBre_22A"))
  ...
  # save(CBre_22A, file="Output//Model22A.RData")
  
if(!exists("Term_22A"))
  Term_22A <- glmer (data=oco,
                   b_Term ~ Crisis +NoCompOffr+
                     b_UCA+
                     # c_OffCri+
                     OffPlace+ 
