...
summary_residual_compare(CBre_11D,CBre_11E,Term_11B,Term_11C,bins=30)
...
#Multi-Level Model
### 22A: Product/Service/R&D and Platform
```{r Model22A}
...
load("model22A.rdata")  
  ...
  CBre_22A <- glmer (data=crisis_smp,
                    b_CBre ~ Crisis + NoComp +
                     b_UCA +
                     Reach + c_OffCri + 
                     cl_Ceil + 
...
display(CBre_22A)
  ...
  Term_22A <- glmer(data=crisis_smp,
                   b_Term ~ Crisis +
                     b_NoComp +
                     b_UCA +
                     Reach + c_OffCri +
...
stargazer::stargazer(CBre_11B,CBre_22A,Term_11B,Term_22A,type="text",
                        digits=2)
summary_residual_compare(CBre_11B,CBre_22A,Term_11B,Term_22A)

# save(CBre_22A,Term_22A, file="Model22A.RData")
```


### 22B: Interactions
```{r 22B Multilevel w/ Simple + PSA}


load("model22B.rdata")  

  # CBre_22B <- glmer (data=crisis_smp,
  #                  b_CBre ~ Crisis + NoComp + 
  #                    b_UCA +
  #                    Reach + c_OffCri + 
  #                    cl_Ceil + 
  ...
  # display(CBre_22B)
  # 
  # Term_22B <- glmer (data=crisis_smp,
  #                  b_Term ~ Crisis + 
  #                    b_NoComp + 
  #                    b_UCA + 
  #                    Reach + c_OffCri + 
...
stargazer::stargazer(CBre_11B,CBre_22A,CBre_22B,Term_11B,Term_22A,Term_22B,type="text",
                        digits=2)

summary_residual_compare(CBre_22A,CBre_22B,Term_22A,Term_22B)
# save(CBre_22B,Term_22B, file="Model22B.RData")
...
load("Model22C.RData") #Only have CBre at the moment

  # CBre_22C <- glmer (data=crisis_smp,
  #                  b_CBre ~ Crisis + NoComp + 
  #                    b_UCA +
  #                    Reach + c_OffCri + 
  #                    cl_Ceil + 
  ...
  #                  family=binomial(link="logit"))
  # display(Term_22C)
  stargazer::stargazer(CBre_11B,CBre_22A,CBre_22B,CBre_22C,Term_11B,Term_22A,Term_22B,type="text",
                        digits=2)

summary_residual_compare(CBre_22B,CBre_22C,Term_22A,Term_22B)
# save(CBre_22C, file="Model22C.RData")
```
