...
# rm(other)
  ...
  crisis_with_na$HostNation3Category<-factor(crisis_with_na$HostNation3Category)
  crisis_with_na$CrisisProductOrServiceArea<-factor(crisis_with_na$CrisisProductOrServiceArea)
  crisis_with_na$ProductOrServiceCodeText<-factor(crisis_with_na$ProductOrServiceCodeText)
...
### 15D: Product/Service/R&D and Platform
```{r Model15D}
summary(crisis_smp$PSA)
crisis_smp$PSA<-factor(crisis_smp$PSA)
#Frequency Plot
...
load("model15D.rdata")  
  ...
  CBre_15D <- glmer (data=crisis_smp,
                    b_CBre ~ NoComp +
                     b_UCA +
                     Reach + c_OffCri +
                     cl_Ceil +
...
display(CBre_15D)
  ...
  Term_15D <- glmer(data=crisis_smp,
                   b_Term ~ Crisis +
                     b_NoComp +
                     b_UCA +
                     Reach + c_OffCri +
...
stargazer::stargazer(CBre_11B,CBre_15D,Term_11B,Term_15D,type="text",
                        digits=2)
summary_residual_compare(CBre_11B,CBre_15D,Term_11B,Term_15D)
