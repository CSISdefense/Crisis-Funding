...
```
The expectation was not fulfilled for ceiling breaches and was for terminations. International performance of contract had a positive coefficient for ceiling breaches and a negative one for terminations. The pattern is similar to that for office.  

However, the variable exceed the VIF threshold of2.0 for ceiling breaches and was close for terminations, trying this another way.
