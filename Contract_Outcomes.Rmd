...
# 
# # crisis_with_na<-crisis_with_na[complete,]
# 
# 
# #8818392  to 8818392
...
### Model 03F: Undefinitized Contract Awards
...
CBre_03F_curve<-function(x, Comp,Ceil,Days,SIDV,MIDV,OIDV,Fixed){invlogit(
  cbind(1,Comp,Ceil,Days,SIDV,MIDV,OIDV,
        Comp*Ceil,Days*Ceil,Days*Comp,
        Fixed,x,
        Days*x,Days*MIDV,Days*OIDV,
        Comp*x,Comp*MIDV,Comp*OIDV) %*%  coef(CBre_03F))}
...
# Plot the model and Vehicle 
CBre_03G_curve<-function(x, Comp,Ceil,Days,SIDV,MIDV,OIDV,Fixed){invlogit(
  cbind(1,Comp,Ceil,Days,SIDV,MIDV,OIDV,
        Comp*Ceil,Days*Ceil,Days*Comp,
        Fixed,x,
        Days*x,Days*MIDV,Days*OIDV,
        Comp*x,Comp*MIDV,Comp*OIDV) %*%  coef(CBre_03G))}
...
```
The interaction of UCA and Comp does align with the findings of the GAO as to the heightened risk of uncompeted UCA. The magnitude of the coefficentsis is considerable, although the rarity of UCAs means the effect on deviation is fairly small. This can also be seen in the residuals where there is a substantial gap between 0.05 and 0.05 in estimated risk of termination.
...
stargazer::stargazer(CBre_02I,CBre_05A,Term_02I,Term_05A,type="text",
                     digits=2)
...
#Plot the fitted values vs actual results
binned_fitted_versus_cbre_residuals(CBre_05A)

#Plot residuals versus fitted
residuals_cbre_plot(CBre_05A)+
  labs(x="Estimated  Pr (Termination)")

residuals_cbre_plot(CBre_05A,"cl_Ceil")+
  labs(x="Centered Log(Ceiling)")
