...
stargazer::stargazer(CBre_02B,CBre_02D,CBre_02I,Term_02B,Term_02D,Term_02I,
                     type="text",
                     digits=2)

summary_residual_compare(CBre_02B,CBre_02I,Term_02B,Term_02I,bins=3)
...
summary_residual_compare(CBre_03B,CBre_04B,Term_03A,Term_04B)
...
```
Expectations were not upheld. With terminations, no results reached 0.05 significance. With ceiling breaches, nothing reached 0.01 significance.
...
```
Expectations were countered for ceiling breaches but a more mixed bag for terminations. This substantially confuses hypothesis analysis, but is significant and thus is kept.
...
stargazer::stargazer(CBre_04K,CBre_04L,Term_04K,Term_04L,type="text",
                     digits=2)



summary_residual_compare(CBre_04K,CBre_04L,Term_04K,Term_04L,10)



```
Expectations were partially fulfilled. A significant positive relationship is present for urgency in particular. However, the sign goes in the opposite direction for other forms of contracting, albeit not significantly. The strong negative relationship for mixed contracting office is surprising, but not directly addressed by the expectation.
...
stargazer::stargazer(CBre_04K,CBre_05A,Term_04K,Term_05A,type="text",
                     digits=2)
