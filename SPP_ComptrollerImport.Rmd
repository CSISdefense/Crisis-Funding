...
for(sfy in SourceFolderList){
  ...
  write.csv(MilPersData,file.path("Data","MilPers.csv"))
}
...
write.csv(OnMdata,file.path("Data","OnM.csv"))
...
write.csv(RFdata,file.path("Data","RF.csv"))
...
write.csv(ProcData,file.path("Data","Proc.csv"))
...
write.csv(RDTEdata,file.path("Data","RDTE.csv"))
