...
```{r OnM}
# Load workbook o1
OnMXLS <- XLConnect::loadWorkbook(file.path("Data","FY2011","o1.xls"))
...
MilConXLS <- loadWorkbook(file.path("Data","FY2011","c1.xls"))
getSheets(MilConXLS)
MilConData<-NULL
...
MilConData <- MilConData %>% select(-variable)
MilConData <- MilConData[,names(MilConData) != "sheet"]
...
colnames(MilConData)
MilConData$SourceFiscalYear<-2011
