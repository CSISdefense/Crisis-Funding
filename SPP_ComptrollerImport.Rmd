...
for(sfy in SourceFolderList){
  MilPersXLS <- XLConnect::loadWorkbook(file.path("Data",sfy,"m1a.xlsx"))
  ...
  write.csv(MilPersData,file.path("Data","MilPers(2017).csv"))
}
...
```{r OnM}
# Load workbook o1
OnMXLS <- XLConnect::loadWorkbook(file.path("Data","FY2017","o1.xlsx"))
...
write.csv(OnMdata,file.path("Data","OnM(2017).csv"))
