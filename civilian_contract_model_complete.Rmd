...
save(file="Data\\Federal_contract_CSIScontractID_detail.Rdata",FederalModelAndDetail)
...
FederalModelAndDetail$UnmodifiedNumberOfOffersReceived[is.na(FederalModelAndDetail$UnmodifiedNumberOfOffersReceived)&
    ...
    FederalModelAndDetail$UnmodifiedIsSomeCompetition==0
  ]<-1
...
#Calculate Comp
FederalModelAndDetail$Comp[FederalModelAndDetail$UnmodifiedIsSomeCompetition==0]<-"No Comp."
...
FederalModelAndDetail$Comp[FederalModelAndDetail$UnmodifiedIsSomeCompetition==1]<-"Comp."

#Competition and Offer  
FederalModelAndDetail$EffComp<-FederalModelAndDetail$Comp

FederalModelAndDetail$EffComp[FederalModelAndDetail$Comp=="Comp." & !is.na(FederalModelAndDetail$Comp)]<-
  ifelse(FederalModelAndDetail$UnmodifiedNumberOfOffersReceived[FederalModelAndDetail$Comp=="Comp." & !is.na(FederalModelAndDetail$Comp)]>1,"2+ Offers","1 Offer")

FederalModelAndDetail$Comp<-factor(FederalModelAndDetail$Comp,
                               levels=c("No Comp.","Comp.")
                                                              )
FederalModelAndDetail$EffComp<-factor(FederalModelAndDetail$EffComp,
...
FederalModelAndDetail$unmodifiedaward_type_code[
  is.na(FederalModelAndDetail$unmodifiedaward_type_code)]<-
  FederalModelAndDetail$Award_Type_Code[
    is.na(FederalModelAndDetail$unmodifiedaward_type_code)]


#idv_type_code Impute missing values when labeled entries have a consistent value.
FederalModelAndDetail$unmodifiedidv_type_code[
  is.na(FederalModelAndDetail$unmodifiedidv_type_code)]<-
  FederalModelAndDetail$IDV_Type_Code[
    is.na(FederalModelAndDetail$unmodifiedidv_type_code)]


#Unmodifiedmultipleorsingleawardidc Impute missing values when labeled entries have a consistent value.
FederalModelAndDetail$Unmodifiedmultipleorsingleawardidc[
  is.na(FederalModelAndDetail$Unmodifiedmultipleorsingleawardidc)]<-
  FederalModelAndDetail$multipleorsingleawardidc[
    is.na(FederalModelAndDetail$Unmodifiedmultipleorsingleawardidc)]

#Assign Is IDV
#A = BPA Call, C = Delivery Order
FederalModelAndDetail$IsIDV[!is.na(FederalModelAndDetail$unmodifiedaward_type_code) &
                               FederalModelAndDetail$unmodifiedaward_type_code %in% c("A","C")]<-1
#B = Purchase Order, D = Definitive Contract
FederalModelAndDetail$IsIDV[!is.na(FederalModelAndDetail$unmodifiedaward_type_code) &
                               FederalModelAndDetail$unmodifiedaward_type_code %in% c("B","D")]<-0
FederalModelAndDetail$IsIDV[!is.na(FederalModelAndDetail$unmodifiedidv_type_code)]<-1
...
FederalModelAndDetail$SimpleVehicle[
  !is.na(FederalModelAndDetail$unmodifiedaward_type_code) &
    FederalModelAndDetail$unmodifiedaward_type_code %in% c("B","D")]<-"Def/Pur"


FederalModelAndDetail$SimpleVehicle[
  !is.na(FederalModelAndDetail$unmodifiedidv_type_code) &
    FederalModelAndDetail$unmodifiedidv_type_code %in% c("B") &
    !is.na(FederalModelAndDetail$Unmodifiedmultipleorsingleawardidc)]<-
  paste(FederalModelAndDetail$Unmodifiedmultipleorsingleawardidc[
     !is.na(FederalModelAndDetail$unmodifiedidv_type_code) &
    FederalModelAndDetail$unmodifiedidv_type_code %in% c("B") &
    !is.na(FederalModelAndDetail$Unmodifiedmultipleorsingleawardidc)
  ],"IDC")
...
FederalModelAndDetail$SimpleVehicle[
  !is.na(FederalModelAndDetail$unmodifiedidv_type_code) &
    FederalModelAndDetail$unmodifiedidv_type_code %in% c("D","E") |
  !is.na(FederalModelAndDetail$unmodifiedaward_type_code) &
    FederalModelAndDetail$unmodifiedaward_type_code %in% c("A") 
    ]<-
  "BPA/BOA"
...
FederalModelAndDetail$SimpleVehicle[
  is.na(FederalModelAndDetail$SimpleVehicle)&
  is.na(FederalModelAndDetail$unmodifiedidv_type_code) &
    !is.na(FederalModelAndDetail$Unmodifiedmultipleorsingleawardidc)]<-
  paste(FederalModelAndDetail$Unmodifiedmultipleorsingleawardidc[
  is.na(FederalModelAndDetail$SimpleVehicle)&
  is.na(FederalModelAndDetail$unmodifiedidv_type_code) &
    !is.na(FederalModelAndDetail$Unmodifiedmultipleorsingleawardidc)],"IDC")
...
FederalModelAndDetail$IsIDV[
  is.na(FederalModelAndDetail$IsIDV)&
    FederalModelAndDetail$SimpleVehicle %in% c(
...
FederalModelAndDetail$UnmodifiedIsUCA[is.na(FederalModelAndDetail$UnmodifiedIsUCA)&
  !is.na(FederalModelAndDetail$IsUCA)]<-
  FederalModelAndDetail$UCA[is.na(FederalModelAndDetail$UnmodifiedIsUCA)&
  !is.na(FederalModelAndDetail$IsUCA)]



FederalModelAndDetail$UCA<-factor(FederalModelAndDetail$UnmodifiedIsUCA,
  levels=c(0,1),
