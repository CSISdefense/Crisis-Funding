...
# ))
save(file="LargeDataSets\\Civilian_contract_CSIScontractID_complete.Rdata",CivilianContracts)
...
# load(file="LargeDataSets\\Civilian_contract_CSIScontractID_complete.Rdata")
...
CivilianContracts<-csis360::read_and_join_experiment(data=CivilianContracts
  ,"Civilian_contract_SP_ContractUnmodifiedCompetitionvehicleCustomer.csv"
  ,path=""
  ,"LargeDataSets\\"
  ,by="CSIScontractID"
  ,new_var_checked=FALSE
...
```{r ModelOutput}
CivilianModel<-subset(CivilianContracts,select=c(IsIDV,
  FixedOrCost,
...
colnames(CivilianModel)[colnames(CivilianModel)=="SubCustomer.sum"]<-"Who"
colnames(CivilianModel)[colnames(CivilianModel)=="UnmodifiedIsSomeCompetition"]<-"Comp"
colnames(CivilianModel)[colnames(CivilianModel)=="PlatformPortfolio.sum"]<-"What"
colnames(CivilianModel)[colnames(CivilianModel)=="IsIDV"]<-"IDV"
colnames(CivilianModel)[colnames(CivilianModel)=="FixedOrCost"]<-"FxCb"
colnames(CivilianModel)[colnames(CivilianModel)=="AnyPlaceInternational"]<-"Intl"
colnames(CivilianModel)[colnames(CivilianModel)=="SimpleArea"]<-"PSR"
colnames(CivilianModel)[colnames(CivilianModel)=="qLowCeiling"]<-"LowCeil"
colnames(CivilianModel)[colnames(CivilianModel)=="qHighCeiling"]<-"Ceil"
colnames(CivilianModel)[colnames(CivilianModel)=="qDuration"]<-"Dur"
# colnames(CivilianModel)[colnames(CivilianModel)=="SingleOffer"]<-"One"
colnames(CivilianModel)[colnames(CivilianModel)=="qOffers"]<-"Offr"
colnames(CivilianModel)[colnames(CivilianModel)=="IsTerminated"]<-"Term"
colnames(CivilianModel)[colnames(CivilianModel)=="SimpleVehicle"]<-"Veh"
colnames(CivilianModel)[colnames(CivilianModel)=="LabeledMDAP"]<-"MDAP"
colnames(CivilianModel)[colnames(CivilianModel)=="qNChg"]<-"NChg"
colnames(CivilianModel)[colnames(CivilianModel)=="qCRais"]<-"CRai"




summary(CivilianModel)
summary(subset(CivilianModel,is.na(Offr)))
summary(subset(CivilianContracts,is.na(qOffers)))
summary(subset(CivilianContracts,is.na(FixedOrCost)&IsFixedPrice==1))
save(CivilianModel,file="LargeDataSets\\Civilian_contract_CSIScontractID_model.Rdata")
write.table(CivilianModel
  ,file=paste("LargeDataSets\\Civilian_contract_CSIScontractID_model.csv"
    ,sep=""
  )
  #   ,header=TRUE
  , sep=","
...
```{r DetailedOutput}
CivilianModelAndDetail<-CivilianContracts

CivilianContracts<-apply_lookups(Path,CivilianContracts)

colnames(CivilianModelAndDetail)[colnames(CivilianModelAndDetail)=="SubCustomer.sum"]<-"Who"
colnames(CivilianModelAndDetail)[colnames(CivilianModelAndDetail)=="UnmodifiedIsSomeCompetition"]<-"Comp"
colnames(CivilianModelAndDetail)[colnames(CivilianModelAndDetail)=="PlatformPortfolio.sum"]<-"What"
colnames(CivilianModelAndDetail)[colnames(CivilianModelAndDetail)=="IsIDV"]<-"IDV"
colnames(CivilianModelAndDetail)[colnames(CivilianModelAndDetail)=="FixedOrCost"]<-"FxCb"
colnames(CivilianModelAndDetail)[colnames(CivilianModelAndDetail)=="AnyPlaceInternational"]<-"Intl"
colnames(CivilianModelAndDetail)[colnames(CivilianModelAndDetail)=="SimpleArea"]<-"PSR"
colnames(CivilianModelAndDetail)[colnames(CivilianModelAndDetail)=="qLowCeiling"]<-"LowCeil"
colnames(CivilianModelAndDetail)[colnames(CivilianModelAndDetail)=="qHighCeiling"]<-"Ceil"
colnames(CivilianModelAndDetail)[colnames(CivilianModelAndDetail)=="qDuration"]<-"Dur"
# colnames(CivilianModelAndDetail)[colnames(CivilianModelAndDetail)=="SingleOffer"]<-"One"
colnames(CivilianModelAndDetail)[colnames(CivilianModelAndDetail)=="qOffers"]<-"Offr"
colnames(CivilianModelAndDetail)[colnames(CivilianModelAndDetail)=="IsTerminated"]<-"Term"
colnames(CivilianModelAndDetail)[colnames(CivilianModelAndDetail)=="SimpleVehicle"]<-"Veh"
colnames(CivilianModelAndDetail)[colnames(CivilianModelAndDetail)=="LabeledMDAP"]<-"MDAP"
colnames(CivilianModelAndDetail)[colnames(CivilianModelAndDetail)=="qNChg"]<-"NChg"
colnames(CivilianModelAndDetail)[colnames(CivilianModelAndDetail)=="qCRais"]<-"CRai"

CivilianModelAndDetail<-subset(CivilianModelAndDetail,select=c(CSIScontractID,
  # IsIDV,
  FxCb,
  Fee,
  # Comp,
...
save(CivilianModelAndDetail,file="LargeDataSets\\Civilian_contract_CSIScontractID_detail.Rdata")
...
load(file="LargeDataSets\\Defense_contract_CSIScontractID_detail.Rdata")
...
FederalModelAndDetail<-rbind(DefenseModelAndDetail,CivilianModelAndDetail)
save(FederalModelAndDetail,file="LargeDataSets\\Federal_contract_CSIScontractID_detail.Rdata")
