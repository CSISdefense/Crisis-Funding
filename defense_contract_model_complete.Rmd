...
def_full$EffComp[def_full$Comp=="Comp." & !is.na(def_full$Comp)]<-
  ifelse(def_full$UnmodifiedNumberOfOffersReceived[def_full$Comp=="Comp." & 
                                                     !is.na(def_full$Comp)]>1,"2+ Offers","1 Offer")
