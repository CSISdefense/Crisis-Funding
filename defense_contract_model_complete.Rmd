...
DefenseContracts <-readr::read_delim(
  "LargeDataSets\\defense_contract_SP_ContractSampleCriteriaDetailsCustomer.csv",
  col_names=TRUE, 
  delim=",",
  # , dec=".",
  trim_ws=TRUE,
...
DefenseContracts<-subset(DefenseContracts,
  ...
  &
    (LastCurrentCompletionDate<=strptime("2016-09-30","%Y-%m-%d") | IsClosed==1)
)
...
# ))
save(file="LargeDataSets\\defense_contract_CSIScontractID_complete.Rdata",DefenseContracts)
load(file="LargeDataSets\\defense_contract_CSIScontractID_complete.Rdata")
...
DefenseContracts$ObligatedAmountIsInternational<-FactorToNumber(DefenseContracts$ObligatedAmountIsInternational)
DefenseContracts$pIsInternational<-DefenseContracts$ObligatedAmountIsInternational/
  DefenseContracts$Action.Obligation
DefenseContracts$pIsInternational[is.na(DefenseContracts$ObligatedAmountIsInternational)] <- 0

if(is.numeric(DefenseContracts$AnyInternational)){
  DefenseContracts$AnyInternational<-factor(DefenseContracts$AnyInternational,
    exclude=NULL,
    levels=c(0,1,NA),
    labels=c("Just U.S.","Any International","Unlabeled")
  )
}
DefenseContracts$AnyInternational[DefenseContracts$pIsInternational<=0 & 
    DefenseContracts$AnyInternational=="Any International" &
    DefenseContracts$UnmodifiedIsInternational==0]<-"Just U.S."
...
DefenseContracts$AnyInternational<-droplevels(DefenseContracts$AnyInternational)
...
```{r ModelOutput}
DefenseModel<-subset(DefenseContracts,select=c(IsIDV,
  FixedOrCost,
...
colnames(DefenseModel)[colnames(DefenseModel)=="SubCustomer.sum"]<-"Who"
colnames(DefenseModel)[colnames(DefenseModel)=="UnmodifiedIsSomeCompetition"]<-"Comp"
colnames(DefenseModel)[colnames(DefenseModel)=="PlatformPortfolio.sum"]<-"What"
colnames(DefenseModel)[colnames(DefenseModel)=="IsIDV"]<-"IDV"
colnames(DefenseModel)[colnames(DefenseModel)=="FixedOrCost"]<-"FxCb"
colnames(DefenseModel)[colnames(DefenseModel)=="AnyInternational"]<-"Intl"
colnames(DefenseModel)[colnames(DefenseModel)=="SimpleArea"]<-"PSR"
colnames(DefenseModel)[colnames(DefenseModel)=="qLowCeiling"]<-"LowCeil"
colnames(DefenseModel)[colnames(DefenseModel)=="qHighCeiling"]<-"Ceil"
colnames(DefenseModel)[colnames(DefenseModel)=="qDuration"]<-"Dur"
# colnames(DefenseModel)[colnames(DefenseModel)=="SingleOffer"]<-"One"
colnames(DefenseModel)[colnames(DefenseModel)=="qOffers"]<-"Offr"
colnames(DefenseModel)[colnames(DefenseModel)=="IsTerminated"]<-"Term"
colnames(DefenseModel)[colnames(DefenseModel)=="SimpleVehicle"]<-"Veh"
colnames(DefenseModel)[colnames(DefenseModel)=="LabeledMDAP"]<-"MDAP"
colnames(DefenseModel)[colnames(DefenseModel)=="qNChg"]<-"NChg"
colnames(DefenseModel)[colnames(DefenseModel)=="qCRais"]<-"CRai"




summary(DefenseModel)
summary(subset(DefenseModel,is.na(Offr)))
summary(subset(DefenseContracts,is.na(qOffers)))
summary(subset(DefenseContracts,is.na(FixedOrCost)&IsFixedPrice==1))
save(DefenseModel,file="LargeDataSets\\defense_contract_CSIScontractID_model.Rdata")
write.table(DefenseModel
...
```{r DetailedOutput}
DefenseModelAndDetail<-DefenseContracts

colnames(DefenseModelAndDetail)[colnames(DefenseModelAndDetail)=="SubCustomer.sum"]<-"Who"
colnames(DefenseModelAndDetail)[colnames(DefenseModelAndDetail)=="UnmodifiedIsSomeCompetition"]<-"Comp"
colnames(DefenseModelAndDetail)[colnames(DefenseModelAndDetail)=="PlatformPortfolio.sum"]<-"What"
colnames(DefenseModelAndDetail)[colnames(DefenseModelAndDetail)=="IsIDV"]<-"IDV"
colnames(DefenseModelAndDetail)[colnames(DefenseModelAndDetail)=="FixedOrCost"]<-"FxCb"
colnames(DefenseModelAndDetail)[colnames(DefenseModelAndDetail)=="AnyInternational"]<-"Intl"
colnames(DefenseModelAndDetail)[colnames(DefenseModelAndDetail)=="SimpleArea"]<-"PSR"
colnames(DefenseModelAndDetail)[colnames(DefenseModelAndDetail)=="qLowCeiling"]<-"LowCeil"
colnames(DefenseModelAndDetail)[colnames(DefenseModelAndDetail)=="qHighCeiling"]<-"Ceil"
colnames(DefenseModelAndDetail)[colnames(DefenseModelAndDetail)=="qDuration"]<-"Dur"
# colnames(DefenseModelAndDetail)[colnames(DefenseModelAndDetail)=="SingleOffer"]<-"One"
colnames(DefenseModelAndDetail)[colnames(DefenseModelAndDetail)=="qOffers"]<-"Offr"
colnames(DefenseModelAndDetail)[colnames(DefenseModelAndDetail)=="IsTerminated"]<-"Term"
colnames(DefenseModelAndDetail)[colnames(DefenseModelAndDetail)=="SimpleVehicle"]<-"Veh"
colnames(DefenseModelAndDetail)[colnames(DefenseModelAndDetail)=="LabeledMDAP"]<-"MDAP"
colnames(DefenseModelAndDetail)[colnames(DefenseModelAndDetail)=="qNChg"]<-"NChg"
colnames(DefenseModelAndDetail)[colnames(DefenseModelAndDetail)=="qCRais"]<-"CRai"
...
save(DefenseModelAndDetail,file="LargeDataSets\\defense_contract_CSIScontractID_detail.Rdata")
