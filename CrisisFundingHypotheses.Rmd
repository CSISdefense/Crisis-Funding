...
CompetitionSupplyServiceFRC<-ddply(FullData,
                .(
                  Fiscal.Year,
                  IsCSISOCO,
                  No.Competition.sum,
...
CompetitionSupplyServiceFRC<-ddply(CompetitionSupplyServiceFRC,
                .(
                  Fiscal.Year,
                  IsCSISOCO,
                  SupplyServiceFRC
...
ggplot(subset(CompetitionSupplyServiceFRC,SupplyServiceFRC!="Unlabeled"),
  aes(x=Fiscal.Year,y=pObligations,color=No.Competition.sum))+
  geom_line(stat="identity")+
  facet_grid(  IsCSISOCO~ SupplyServiceFRC)+scale_fill_discrete(guide = guide_legend(reverse=FALSE))+
...
FullData$isUCA<-factor(FullData$isUndefinitizedAction)
FullData$isUCA[is.na(FullData$isUCA)]<-0
#UCA and Simple Area
UCASupplyServiceFRC<-ddply(FullData,
                .(
                  Fiscal.Year,
                  IsCSISOCO,
                  isUCA,
...
UCASupplyServiceFRC<-ddply(UCASupplyServiceFRC,
                .(
                  Fiscal.Year,
                  IsCSISOCO,
                  SupplyServiceFRC
...
ggplot(subset(UCASupplyServiceFRC,SupplyServiceFRC!="Unlabeled"),
