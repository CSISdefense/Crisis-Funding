...
fed_full$Disasterstep4GrossObligated<-as.numeric(fed_full$Disasterstep4GrossObligated)
fed_full$DisastertransactionGrossObligated<-as.numeric(fed_full$DisastertransactionGrossObligated)
  # fed_full$Disasterstep4GrossObligated[!is.na(fed_full$Disasterstep4GrossObligated) &
  #                                        is.na(as.numeric(fed_full$Disasterstep4GrossObligated))]

#   ARRAstep4grossObligated = col_double(),
#   OCOstep4grossObligated = col_double(),
#   Disasterstep4GrossObligated = col_character(),
#   ExcludedStep4GrossObligated = col_double(),

#   ARRAtransactionGrossObligated = col_double(),
#   OCOtransactionGrossObligated = col_double(),
#   DisastertransactionGrossObligated = col_character(),
#   ExcludedtransactionGrossObligated = col_double(),

#   pscOCOcrisisMeanPercent = col_double(),
#   FundingAccountOCOmeanPercent = col_double(),
#   OfficeOCOcrisisMeanPercent = col_double(),
#   GrossObligatedAmount = col_double()
...
#Counting Ties
nrow(fed_full[
  fed_full$ARRAtransactionGrossObligated==fed_full$OCOtransactionGrossObligated &
    fed_full$ARRAtransactionGrossObligated>0 &
    !is.na(fed_full$OCOtransactionGrossObligated)&
    !is.na(fed_full$ARRAtransactionGrossObligated)
  ,])#0
nrow(fed_full[
    fed_full$OCOtransactionGrossObligated==fed_full$DisastertransactionGrossObligated  & 
      fed_full$OCOtransactionGrossObligated>0&
      !is.na(fed_full$OCOtransactionGrossObligated)&
      !is.na(fed_full$DisastertransactionGrossObligated)
    ,])#3
nrow(fed_full[
...
fed_full$NewCrisis<-NA
fed_full$NewCrisis[fed_full$ARRAtransactionGrossObligated==
                     fed_full$GrossObligatedAmount]<-"ARRA"
fed_full$NewCrisis[fed_full$DisastertransactionGrossObligated==
                     fed_full$GrossObligatedAmount]<-"Disaster"
fed_full$NewCrisis[fed_full$OCOtransactionGrossObligated==
                     fed_full$GrossObligatedAmount]<-"OCO"
fed_full$NewCrisis[fed_full$ExcludedtransactionGrossObligated==
                     fed_full$GrossObligatedAmount & 
                     is.na(fed_full$NewCrisis)]<-"Excluded"

summary(factor(fed_full$NewCrisis))
summary(fed_full$MaxOfDecisionTree)
nrow(fed_full[ (fed_full$ARRAtransactionGrossObligated>0 & !is.na(fed_full$ARRAtransactionGrossObligated)) |
    (fed_full$DisastertransactionGrossObligated> 0 & !is.na(fed_full$DisastertransactionGrossObligated)) | 
      (fed_full$OCOtransactionGrossObligated>0
       & !is.na(fed_full$OCOtransactionGrossObligated)) & is.na(fed_full$NewCrisis)
              ,])#80997
