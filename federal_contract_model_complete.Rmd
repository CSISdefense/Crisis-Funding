...
fed_full$TreasuryAgencyCode[is.na(fed_full$TreasuryAgencyCode)&
                            fed_full$OriginIsInternational==1]<-"*M"
...
summary(fed_full$UnmodifiedTreasuryAgencyCode)
...
fed_full<-fed_full[,!colnames(fed_full) %in% 
  ...
  "ObligatedAmountAnySubAccountCode"     ,
   # "AnySubAccountCode",
  "AnySubAccountCode"  ,
  "UnmodifiedAnySubAccountCode",
   # "MainAccountCode",
  "UnmodifiedMainAccountCode" ,
  "ObligatedAmountAnyMainAccountCode"  ,
   "AnyMainAccountCode",
  "AnyMainAccountCode",
  "UnmodifiedAnyMainAccountCode"         ,
   # "TreasuryAgencyCode",
