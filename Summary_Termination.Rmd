...
source("https://raw.githubusercontent.com/CSISdefense/Vendor/master/DIIGstat")
...
debug(decision_tree)
DefenseModelAndDetail<-decision_tree(DefenseModelAndDetail)

summary(DefenseModelAndDetail$DecisionTreeDisplay)
# DefenseModelAndDetail<-subset(DefenseModelAndDetail,DecisionTreeDisplay != "Not in Sample")
# save(complete_DefenseModelAndDetail,DefenseModelAndDetail,file="data//DefenseModelAndDetail.Rdata")


View(DefenseModelAndDetail[is.na(DefenseModelAndDetail$DecisionTreeDisplay),])


summary(DefenseModelAndDetail$DecisionTree)
summary(DefenseModelAndDetail$DecisionTreeDisplay)
write.csv(subset(DefenseModelAndDetail,Term=="Terminated"),"LargeDataSets//Terminated.csv")

save(DefenseModelAndDetail,file="LargeDataSets//FederalModelForTerminations.RData")
...
TerminatedSDurSCeilStatCount<-subset(DefenseModelAndDetail,
         !is.na(Dur.Simple) & 
           !is.na(Ceil.Simple) &
...
df.QCrai.Comp<-subset(DefenseModelAndDetail,
                                        !is.na(Dur.Simple) & 
               !is.na(Ceil.Simple) &
               !is.na(CRai) &
...
df.QCrai.UCA<-subset(DefenseModelAndDetail,
                                        !is.na(Dur.Simple) & 
               !is.na(Ceil.Simple) &
               !is.na(CRai) &
                 !is.na(DecisionTreeDisplay) &
