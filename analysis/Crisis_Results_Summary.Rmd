...
# undebug(LatticePlotWrapper_csis360)


summary_data<-summary_data %>% group_by(DecisionTreeDisplay,NoCompOffr) %>%
          mutate(
          ytextposition=cumsum(pDatasetObligation)-0.5*pDatasetObligation)
...
CompOverall<-build_plot(
 ...
 theme(axis.text.x = element_text(angle=90))+
  ...
  expand_limits(y = c(0,0.2))+
        geom_text(aes(label=format(round(pDatasetObligation,3),  scientific=FALSE, trim=TRUE, big.mark=","),
...
#   VAR.facet.primary="Competition.multisum" #VAR.facet.primary
...
ggsave600dpi("..//Output//Figure15_CompOverall.png", CompOverall, 
             width=4.5, height= 6, units="in",size=11
             )
...
load(file.path("..","Data","crisis_smp.Rdata"))
