...
colnames(large_crisis_smp)[colnames(large_crisis_smp)=="PlaceCountryISO3"]<-"alpha.3"
debug(read_and_join)
    large_crisis_smp<-csis360::read_and_join( large_crisis_smp,
                                      "Location_CountryCodes.csv",
                                      path="https://raw.githubusercontent.com/CSISdefense/Lookup-Tables/master/",
                                      directory="location\\",
                                      by="alpha.3",
                                      add_var=c("isforeign",		"CombatantCommand","CrisisFundingTheater","name"),
                                      new_var_checked=TRUE)

colnames(large_crisis_smp)[colnames(large_crisis_smp)=="alpha.3"]<-"PlaceCountryISO3"
colnames(large_crisis_smp)[colnames(large_crisis_smp)=="CrisisFundingTheater"]<-"place_CrisisFundingTheater"

place_CrisisFundingTheater


summary(large_crisis_smp)
...
get_icc(psc24_term)
      ...
      stargazer::stargazer(psc_term,psc2_term,cpsa_term,ServCommCons_term,
                           psc_all3_term,cpsa_psc_term,ssc_psc_term,psc24_term,type="text",
                     digits=2)
...
### Nested CivDef / Customer / Office
```{r AgencyOffice}
if(!exists("CivDefCustomerOffice_cbre"))
  CivDefCustomerOffice_cbre <- glmer(data=large_crisis_smp,
                             b_CBre ~ (1 | Is.Defense/Customer/Office)
                             , family=binomial(link="logit"),
     control = glmerControl(optimizer = "optimx", calc.derivs = FALSE,
     optCtrl = list(method = "nlminb", starttests = FALSE, kkt = FALSE)))
get_icc(display=TRUE,CivDefCustomerOffice_cbre)


if(!exists("CivDefCustomerOffice_term"))
  CivDefCustomerOffice_term <- glmer(data=large_crisis_smp,
                             b_Term ~ (1 | Is.Defense/Customer/Office)
                             , family=binomial(link="logit"),
     control = glmerControl(optimizer = "optimx", calc.derivs = FALSE,
     optCtrl = list(method = "nlminb", starttests = FALSE, kkt = FALSE)))
get_icc(display=TRUE,CivDefCustomerOffice_term)
...
### Nested CivDef / Agency / Office
```{r AgencyOffice}
if(!exists("CivDefAgencyOffice_cbre"))
  CivDefAgencyOffice_cbre <- glmer(data=large_crisis_smp,
                             b_CBre ~ (1 | Is.Defense/Agency/Office)
                             , family=binomial(link="logit"))
get_icc(display=TRUE,CivDefAgencyOffice_cbre)


if(!exists("CivDefAgencyOffice_term"))
  CivDefAgencyOffice_term <- glmer(data=large_crisis_smp,
                             b_Term ~ (1 | Is.Defense/Agency/Office)
                             , family=binomial(link="logit"))
get_icc(display=TRUE,CivDefAgencyOffice_term)
...
save(Office_cbre,Office_term,
    ...
    CustomerAgencyOffice_cbre,CustomerAgencyOffice_term,
  CivDefCustomerOffice_cbre,  CivDefCustomerOffice_term,
...
if(!exists("Crisis_cbre"))
  Crisis_cbre <- glmer(data=large_crisis_smp,
                       b_CBre ~ (1 | Crisis)
                       , family=binomial(link="logit"))
get_icc(display=TRUE,Crisis_cbre)

if(!exists("Crisis_term"))
  Crisis_term <- glmer(data=large_crisis_smp,
                       b_Term ~ (1| Crisis)
                       , family=binomial(link="logit"))
get_icc(display=TRUE,Crisis_term)

```

### nested PSC Customer/Office and 1 level funding
```{r cpsa_prodserv_customer_office_crisis1level}
# load(file="Output//who_empty_models.rdata")


if(!exists("ssc_prodserv_customer_office_funding1level_cbre"))
  ssc_prodserv_customer_office_funding1level_cbre <- glmer(data=large_crisis_smp,
                             b_CBre ~  (1 | ServCommCons/ProdServ) +
                               (1 | Customer/Office) + 
                               Crisis
                             , family=binomial(link="logit"),
     control = glmerControl(optimizer = "optimx", calc.derivs = FALSE,
     optCtrl = list(method = "nlminb", starttests = FALSE, kkt = FALSE)))
get_icc(display=TRUE,ssc_prodserv_customer_office_funding1level_cbre)

if(!exists("cpsa_prodserv_customer_office_funding_term"))
  cpsa_prodserv_customer_office_funding_term <- glmer(data=large_crisis_smp,
                             b_Term ~  (1 | CrisisProductOrServiceArea/ProdServ) + 
                               (1 | Customer/Office)  + 
                               (1 | Crisis)
                             , family=binomial(link="logit"),
     control = glmerControl(optimizer = "optimx", calc.derivs = FALSE,
     optCtrl = list(method = "nlminb", starttests = FALSE, kkt = FALSE)))
get_icc(display=TRUE,cpsa_prodserv_customer_office_funding_term)


```

### Funding nested PSC Customer/Office
```{r cpsa_prodserv_customer_office_crisis}

if(!exists("ssc_prodserv_customer_office_funding_cbre"))
  ssc_prodserv_customer_office_funding_cbre <- glmer(data=large_crisis_smp,
                             b_CBre ~  (1 | ServCommCons/ProdServ) +
                               (1 | Customer/Office) + 
                               (1 | Crisis)
                             , family=binomial(link="logit"),
     control = glmerControl(optimizer = "optimx", calc.derivs = FALSE,
     optCtrl = list(method = "nlminb", starttests = FALSE, kkt = FALSE)))
get_icc(display=TRUE,ssc_prodserv_customer_office_funding_cbre)
...
### Compare Funding
```{r Empty_Compare_Finding_Term}

save(Crisis1level_cbre,Crisis1level_term,
     Crisis_cbre,Crisis_term,
     ssc_prodserv_customer_office_funding1level_cbre,cpsa_prodserv_customer_office_funding1level_term,
     ssc_prodserv_customer_office_funding_cbre,cpsa_prodserv_customer_office_funding_term,
     file="Output//where_empty_models.rdata")


get_icc(Crisis_cbre)
get_icc(Crisis_term)
get_icc(ssc_prodserv_customer_office_funding1level_cbre)
get_icc(cpsa_prodserv_customer_office_funding1level_term)
get_icc(ssc_prodserv_customer_office_funding_cbre)
get_icc(cpsa_prodserv_customer_office_funding_term)


stargazer::stargazer( Crisis1level_cbre,
Crisis_cbre,
ssc_prodserv_customer_office_funding_cbre,
                     type="text",
                       digits=2)
...
Crisis_term,
cpsa_prodserv_customer_office_funding1level_term,
...
#### Place + Offplace
```{r PlaceCountry_offplace}



# if(!exists("Place_Country_offplace_alone_cbre"))
  Place_Country_offplace_alone_cbre <- glmer(data=large_crisis_smp,
                       b_CBre ~ OffPl99+(1 | PlaceCountryISO3)
                       , family=binomial(link="logit"),
     control = glmerControl(optimizer = "optimx", calc.derivs = FALSE,
     optCtrl = list(method = "nlminb", starttests = FALSE, kkt = FALSE)))

get_icc(display=TRUE,Place_Country_offplace_alone_cbre)

if(!exists("Place_Country_offplace_alone_term"))
  Place_Country_offplace_alone_term <- glmer(data=large_crisis_smp,
                       b_Term ~ OffPl99+(1  | PlaceCountryISO3)
                       , family=binomial(link="logit"),
     control = glmerControl(optimizer = "optimx", calc.derivs = FALSE,
     optCtrl = list(method = "nlminb", starttests = FALSE, kkt = FALSE)))

get_icc(display=TRUE,Place_Country_offplace_alone_term)


# if(!exists("Place_Country_offplace_cbre"))
  Place_Country_offplace_cbre <- glmer(data=large_crisis_smp,
                       b_CBre ~ OffPl99+(1 + OffPl99 | PlaceCountryISO3)
                       , family=binomial(link="logit"),
     control = glmerControl(optimizer = "optimx", calc.derivs = FALSE,
     optCtrl = list(method = "nlminb", starttests = FALSE, kkt = FALSE)))

get_icc(display=TRUE,Place_theater_Country_offplace_theater_cbre)
get_icc(display=TRUE,Place_Country_offplace_cbre)


if(!exists("Place_Country_offplace_term"))
  Place_Country_offplace_term <- glmer(data=large_crisis_smp,
                       b_Term ~ OffPl99+(1 + OffPl99 | PlaceCountryISO3)
                       , family=binomial(link="logit"),
     control = glmerControl(optimizer = "optimx", calc.derivs = FALSE,
     optCtrl = list(method = "nlminb", starttests = FALSE, kkt = FALSE)))

get_icc(display=TRUE,Place_theater_Country_offplace_theater_cbre)
get_icc(display=TRUE,Place_Country_offplace_term)

```

#### Place + Reach
```{r PlaceCountry_reach}


if(!exists("Place_Country_Reach_alone_cbre"))
  Place_Country_Reach_alone_cbre <- glmer(data=large_crisis_smp,
                       b_CBre ~ Reach+(1  | PlaceCountryISO3)
                       , family=binomial(link="logit"),
     control = glmerControl(optimizer = "optimx", calc.derivs = FALSE,
     optCtrl = list(method = "nlminb", starttests = FALSE, kkt = FALSE)))


get_icc(display=TRUE,Place_Country_Reach_alone_cbre)


if(!exists("Place_Country_Reach_alone_term"))
  Place_Country_Reach_alone_term <- glmer(data=large_crisis_smp,
                       b_Term ~ Reach+(1  | PlaceCountryISO3)
                       , family=binomial(link="logit"),
     control = glmerControl(optimizer = "optimx", calc.derivs = FALSE,
     optCtrl = list(method = "nlminb", starttests = FALSE, kkt = FALSE)))

get_icc(display=TRUE,Place_Country_Reach_alone_term)


if(!exists("Place_Country_Reach_cbre"))
  Place_Country_Reach_cbre <- glmer(data=large_crisis_smp,
                       b_CBre ~ Reach+(1+Reach  | PlaceCountryISO3)
                       , family=binomial(link="logit"),
     control = glmerControl(optimizer = "optimx", calc.derivs = FALSE,
     optCtrl = list(method = "nlminb", starttests = FALSE, kkt = FALSE)))


get_icc(display=TRUE,Place_Country_Reach_cbre)


if(!exists("Place_Country_Reach_term"))
  Place_Country_Reach_term <- glmer(data=large_crisis_smp,
                       b_Term ~ Reach+(1+Reach  | PlaceCountryISO3)
                       , family=binomial(link="logit"),
     control = glmerControl(optimizer = "optimx", calc.derivs = FALSE,
     optCtrl = list(method = "nlminb", starttests = FALSE, kkt = FALSE)))

get_icc(display=TRUE,Place_Country_Reach_term)
...
# if(!exists("Place_theater_Country_offplace_theater_cbre"))
  Place_theater_Country_offplace_theater_cbre <- glmer(data=large_crisis_smp,
                       b_CBre ~ OffPl99+(1 | place_CrisisFundingTheater:PlaceCountryISO3)+(1 + OffPl99 | place_CrisisFundingTheater)
                       , family=binomial(link="logit"),
     control = glmerControl(optimizer = "optimx", calc.derivs = FALSE,
     optCtrl = list(method = "nlminb", starttests = FALSE, kkt = FALSE)))
get_icc(display=TRUE,Place_theater_Country_offplace_theater_cbre)

# if(!exists("Place_theater_Country_offplace_theater_term"))
  Place_theater_Country_offplace_theater_term <- glmer(data=large_crisis_smp,
                       b_Term ~ OffPl99+(1 | place_CrisisFundingTheater:PlaceCountryISO3)+(1 + OffPl99 | place_CrisisFundingTheater)
                       , family=binomial(link="logit"),
     control = glmerControl(optimizer = "optimx", calc.derivs = FALSE,
     optCtrl = list(method = "nlminb", starttests = FALSE, kkt = FALSE)))
get_icc(display=TRUE,Place_theater_Country_offplace_theater_term)
...
if(!exists("cpsa_prodserv_customer_office_place_cbre"))
  cpsa_prodserv_customer_office_place_cbre <- glmer(data=large_crisis_smp,
                             b_CBre ~  (1 | CrisisProductOrServiceArea/ProdServ) + (1 | Customer/Office) + (1 | PlaceCountryISO3)
                             , family=binomial(link="logit"))
get_icc(display=TRUE,cpsa_prodserv_customer_office_place_cbre)
...
# load(file="Output//where_empty_models2.rdata")
...
if(!exists("PlaceVendorCombined_cbre"))
  PlaceVendorCombined_cbre <- glmer(data=large_crisis_smp,
                       b_CBre ~ (1 | PlaceCountryISO3 / VendorCountryISO3) 
                       , family=binomial(link="logit"),
     control = glmerControl(optimizer = "optimx", calc.derivs = FALSE,
     optCtrl = list(method = "nlminb", starttests = FALSE, kkt = FALSE)))
get_icc(display=TRUE,PlaceVendorCombined_cbre)

if(!exists("PlaceVendorCombined_term"))
  PlaceVendorCombined_term <- glmer(data=large_crisis_smp,
                       b_Term ~ (1 | PlaceCountryISO3 / VendorCountryISO3)
                       , family=binomial(link="logit"),
     control = glmerControl(optimizer = "optimx", calc.derivs = FALSE,
     optCtrl = list(method = "nlminb", starttests = FALSE, kkt = FALSE)))


get_icc(display=TRUE,PlaceVendorCombined_term)

```

#### Place Vendor Simplified
```{r PlaceVendorCombined}
load(file="Output//where_empty_models.rdata")
...
#### Place & Origin
```{r PlaceOriginCountry}
# load(file="Output//where_empty_models.rdata")

if(!exists("PlaceOriginCountry_cbre"))
  PlaceOriginCountry_cbre <- glmer(data=large_crisis_smp,
                       b_CBre ~ (1 | PlaceCountryISO3) + (1|OriginCountryISO3) 
                       , family=binomial(link="logit"),
     control = glmerControl(optimizer = "optimx", calc.derivs = FALSE,
     optCtrl = list(method = "nlminb", starttests = FALSE, kkt = FALSE)))
get_icc(display=TRUE,PlaceOriginCountry_cbre)

if(!exists("PlaceOriginCountry_term"))
  PlaceOriginCountry_term <- glmer(data=large_crisis_smp,
                       b_Term ~ (1 | PlaceCountryISO3) + (1|OriginCountryISO3)
                       , family=binomial(link="logit"),
     control = glmerControl(optimizer = "optimx", calc.derivs = FALSE,
     optCtrl = list(method = "nlminb", starttests = FALSE, kkt = FALSE)))
...
#### Place / Origin
```{r PlaceOriginCombined}
# load(file="Output//where_empty_models.rdata")

if(!exists("PlaceOriginCombined_cbre"))
  PlaceOriginCombined_cbre <- glmer(data=large_crisis_smp,
                       b_CBre ~ (1 | PlaceCountryISO3/OriginCountryISO3) 
                       , family=binomial(link="logit"),
     control = glmerControl(optimizer = "optimx", calc.derivs = FALSE,
     optCtrl = list(method = "nlminb", starttests = FALSE, kkt = FALSE)))
get_icc(display=TRUE,PlaceOriginCombined_cbre)

if(!exists("PlaceOriginCombined_term"))
  PlaceOriginCombined_term <- glmer(data=large_crisis_smp,
                       b_Term ~ (1 | PlaceCountryISO3/OriginCountryISO3)
                       , family=binomial(link="logit"),
     control = glmerControl(optimizer = "optimx", calc.derivs = FALSE,
     optCtrl = list(method = "nlminb", starttests = FALSE, kkt = FALSE)))
...
summary_discrete_plot(large_crisis_smp,"place_isforeign")
summary_discrete_plot(large_crisis_smp,"place_CombatantCommand")
summary_discrete_plot(large_crisis_smp,"Origin_CrisisFundingTheater")
summary_discrete_plot(large_crisis_smp,"Origin_isforeign")
summary_discrete_plot(large_crisis_smp,"Origin_CombatantCommand")

large_crisis_smp<-place_compare(large_crisis_smp,
                                comparecol="OriginCountryISO3",newcol="PlaceOrigin",comparename="Origin")
large_crisis_smp<-place_compare(large_crisis_smp,
                                comparecol="OriginCountryISO3",newcol="OriginOrigin",comparename="Origin")

  summary_discrete_plot(large_crisis_smp,"PlaceOrigin")

  
if(!exists("PlaceOriginSimplified_cbre"))
  PlaceOriginSimplified_cbre <- glmer(data=large_crisis_smp,
                       b_CBre ~ (1 | PlaceCountryISO3/PlaceOrigin)
                       , family=binomial(link="logit"),
     control = glmerControl(optimizer = "optimx", calc.derivs = FALSE,
     optCtrl = list(method = "nlminb", starttests = FALSE, kkt = FALSE)))
get_icc(display=TRUE,PlaceOriginSimplified_cbre)

if(!exists("PlaceOriginSimplified_term"))
  PlaceOriginSimplified_term <- glmer(data=large_crisis_smp,
                       b_Term ~ (1 | PlaceCountryISO3/PlaceOrigin)
                       , family=binomial(link="logit"),
     control = glmerControl(optimizer = "optimx", calc.derivs = FALSE,
     optCtrl = list(method = "nlminb", starttests = FALSE, kkt = FALSE)))
get_icc(display=TRUE,PlaceOriginSimplified_term)
...
#### Place Vendor Origin Simplified
```{r PlaceVendorOriginCombined}
# load(file="Output//where_empty_models.rdata")
if(!exists("PlaceVendorOriginSimplified_cbre"))
  PlaceVendorOriginSimplified_cbre <- glmer(data=large_crisis_smp,
                       b_CBre ~ (1 | PlaceCountryISO3/PlaceVendor/PlaceOrigin)
                       , family=binomial(link="logit"),
     control = glmerControl(optimizer = "optimx", calc.derivs = FALSE,
     optCtrl = list(method = "nlminb", starttests = FALSE, kkt = FALSE)))
get_icc(display=TRUE,PlaceVendorOriginSimplified_cbre)

if(!exists("PlaceVendorOriginSimplified_term"))
  PlaceVendorOriginSimplified_term <- glmer(data=large_crisis_smp,
                       b_Term ~ (1 | PlaceCountryISO3/PlaceVendor/PlaceOrigin)
                       , family=binomial(link="logit"),
     control = glmerControl(optimizer = "optimx", calc.derivs = FALSE,
     optCtrl = list(method = "nlminb", starttests = FALSE, kkt = FALSE)))
get_icc(display=TRUE,PlaceVendorOriginSimplified_term)
...
if(!exists("ssc_prodserv_customer_office_placevendor_cbre"))
  ssc_prodserv_customer_office_placevendor_cbre <- glmer(data=large_crisis_smp,
                             b_CBre ~  (1 | ServCommCons/ProdServ) + 
                               (1 | Customer/Office) + 
                               (1 | PlaceCountryISO3/PlaceVendor)
                             , family=binomial(link="logit"))
...
#### nested PSC Customer/Office and place
```{r cpsa_prodserv_customer_placevendor_office}

if(!exists("ssc_prodserv_customer_office_placeorigin_combined_cbre"))
  ssc_prodserv_customer_office_placeorigin_combined_cbre <- glmer(data=large_crisis_smp,
                             b_CBre ~  (1 | ServCommCons/ProdServ) + 
                               (1 | Customer/Office) + 
                               (1 | PlaceCountryISO3/OriginCountryISO3)
                             , family=binomial(link="logit"),
     control = glmerControl(optimizer = "optimx", calc.derivs = FALSE,
     optCtrl = list(method = "nlminb", starttests = FALSE, kkt = FALSE)))


get_icc(display=TRUE,ssc_prodserv_customer_office_placeorigin_combined_cbre)

if(!exists("cpsa_prodserv_customer_office_placeorigin_combined_term"))
  cpsa_prodserv_customer_office_placevendor_combined_term <- glmer(data=large_crisis_smp,
                             b_Term ~  (1 | CrisisProductOrServiceArea/ProdServ) +
                               (1 | Customer/Office)+ 
                               (1 | PlaceCountryISO3/OriginCountryISO3)
                             , family=binomial(link="logit"),
...
get_icc(display=TRUE,cpsa_prodserv_customer_office_placeorigin_combined_term)
...
#### nested PSC Customer/Office and place/vendor/offer combined
```{r cpsa_prodserv_customer_placecvendororigin_office}


if(!exists("ssc_prodserv_customer_office_placevendororigin_combined_cbre"))
  ssc_prodserv_customer_office_placevendororigin_combined_cbre <- glmer(data=large_crisis_smp,
                             b_CBre ~  (1 | ServCommCons/ProdServ) + 
                               (1 | Customer/Office) + (1 | PlaceCountryISO3/VendorCountryISO3/OriginCountryISO3)
                             , family=binomial(link="logit"))
get_icc(display=TRUE,ssc_prodserv_customer_office_placevendororigin_combined_cbre)

if(!exists("cpsa_prodserv_customer_office_placevendororigin_term"))
cpsa_prodserv_customer_office_placevendororigin_combined_term <-  glmer(data=large_crisis_smp,
                             b_Term ~  (1 | CrisisProductOrServiceArea/ProdServ) + 
                               (1 | Customer/Office)+ (1 | PlaceCountryISO3/VendorCountryISO3/OriginCountryISO3)
                             , family=binomial(link="logit"),
     control = glmerControl(optimizer = "optimx", calc.derivs = FALSE,
     optCtrl = list(method = "nlminb", starttests = FALSE, kkt = FALSE)))
get_icc(display=TRUE,cpsa_prodserv_customer_office_placevendororigin_combined_term)


save(ssc_prodserv_customer_office_placevendororigin_combined_cbre,cpsa_prodserv_customer_office_placevendororigin_combined_term,file="placevendororigin_combined.rdata")
```
...
save(PlaceCountry_cbre,PlaceCountry_term,
     Place_Country_offplace_alone_cbre,Place_Country_offplace_alone_term,
     Place_Country_offplace_cbre,Place_Country_offplace_term,
     Place_Country_Reach_alone_cbre,Place_Country_Reach_alone_term,
     Place_Country_Reach_cbre,Place_Country_Reach_term,
     Place_theater_Country_cbre,Place_theater_Country_term,
     Place_theater_Country_offplace_theater_cbre,Place_theater_Country_offplace_theater_term,
     ssc_prodserv_customer_office_place_cbre,cpsa_prodserv_customer_office_place_cbre,cpsa_prodserv_customer_office_place_term,
      file="Output//where_empty_models.rdata"
     )

stargazer::stargazer( PlaceCountry_cbre,
                      Place_Country_offplace_alone_cbre,
                      Place_Country_offplace_cbre,
                      Place_Country_Reach_alone_cbre,
                      Place_Country_Reach_cbre,
                      Place_theater_Country_cbre,
                      
                      Place_theater_Country_offplace_theater_cbre,
                                            type="text",
                      digits=2)



stargazer::stargazer( ssc_prodserv_customer_office_place_cbre,
                      cpsa_prodserv_customer_office_place_cbre,
                      cpsa_prodserv_customer_office_place_term,
                      type="text",
                      digits=2)
...
stargazer::stargazer( PlaceCountry_term,
                      ...
                      Place_Country_offplace_alone_term,
                      Place_Country_offplace_term,
                      Place_Country_Reach_alone_term,
                      Place_Country_Reach_term,
                      Place_theater_Country_term,
                      Place_theater_Country_offplace_theater_term,
                      type="text",
                      digits=2)


get_icc(PlaceCountry_cbre)
get_icc(Place_Country_offplace_cbre)
get_icc(Place_theater_Country_cbre)
get_icc(Place_theater_Country_offplace_theater_cbre)


get_icc(PlaceCountry_term)
get_icc(Place_Country_offplace_term)
get_icc(Place_theater_Country_term)
get_icc(Place_theater_Country_offplace_theater_term)
...
,
  ...
  save(PlaceCountry_cbre,PlaceCountry_term,
       ...
       PlaceVendorOriginSimplified_cbre,PlaceVendorOriginSimplified_term,
       ...
       PlaceOriginCountry_cbre,PlaceOriginCountry_term,
       PlaceOriginSimplified_cbre,PlaceOriginSimplified_term,
       PlaceOriginCombined_cbre,PlaceOriginCombined_term,
       file="Output//where_alone_empty_models.rdata"
  )
  
  # load("Output//where_empty_models.rdata") 
  # 
  #     load("Output//where_prior_empty_models.rdata") 
  #     load("Output//ssc_prodserv_customer_office_placeorigin_cbre.rdata") 
save(   
  ...
  cpsa_prodserv_customer_office_origin_term, #Needs to be updated
  
         ssc_prodserv_customer_office_placevendor_cbre,
  cpsa_prodserv_customer_office_placevendor_term,
  
           ssc_prodserv_customer_office_placevendor_when_cbre,
  cpsa_prodserv_customer_office_placevendor_when_term,
  
    ssc_prodserv_customer_office_placeorigin_cbre,   
  cpsa_prodserv_customer_office_placeorigin_term,
  
  ssc_prodserv_customer_office_placeorigin_combined_cbre,
  
  # ssc_prodserv_customer_office_placevendororigin_cbre,
  # cpsa_prodserv_customer_office_placevendororigin_term,
  
       ssc_prodserv_customer_office_placevendororigin_combined_cbre,
cpsa_prodserv_customer_office_placevendororigin_combined_term,
       
       file="Output//where_prior_empty_models.rdata")



save(ssc_prodserv_customer_office_origin_cbre,file="ssc_prodserv_customer_office_origin_cbre_update.rdata")
  ...
  save(PlaceCountry_cbre,PlaceCountry_term,
       ...
       # ssc_prodserv_customer_office_placeorigin_cbre,ssc_prodserv_customer_office_placeorigin_term,
       PlaceVendorCountry_term_test,
       PlaceVendorCombined_cbre,PlaceVendorCombined_term,
       PlaceVendorSimplified_cbre,PlaceVendorSimplified_term,
       ssc_prodserv_customer_office_placevendor_when_cbre,cpsa_prodserv_customer_office_placevendor_when_term,
       # PlaceVendorOriginNested_cbre,PlaceVendorOriginNested_term,
       file="Output//where_empty_models.rdata")

load("Output//where_alone_empty_models.rdata")
load("Output//where_prior_empty_models.rdata")
load("Output//where_empty_models.rdata")
ssc_prodserv_customer_office_placeorigin_cbre.rdata
...
save(ssc_prodserv_customer_office_placeorigin_combined_cbre,file="placeorigin_combined.rdata")
load(file="output//placeorigin_combined.rdata")
cpsa_prodserv_customer_office_place_term<-
  update(cpsa_prodserv_customer_office_place_term)
cpsa_prodserv_customer_office_vendor_term<-
  update(cpsa_prodserv_customer_office_vendor_term)
ssc_prodserv_customer_office_origin_cbre<-
  update(ssc_prodserv_customer_office_origin_cbre)
cpsa_prodserv_customer_office_placevendor_term<-
  update(cpsa_prodserv_customer_office_placevendor_term)

cpsa_prodserv_customer_office_placevendor_when_term<-
  update(cpsa_prodserv_customer_office_placevendor_when_term)
cpsa_prodserv_customer_office_funding_term<-update(cpsa_prodserv_customer_office_placevendor_when_term)
cpsa_prodserv_customer_office_startfy_term<-update(cpsa_prodserv_customer_office_placevendor_when_term)
cpsa_prodserv_customer_office_term<-update(cpsa_prodserv_customer_office_placevendor_when_term)
...
get_icc(PlaceOriginCountry_cbre)
get_icc(PlaceOriginCombined_cbre)
get_icc(PlaceOriginSimplified_cbre)
get_icc(PlaceVendorOriginCountry_cbre)
get_icc(PlaceVendorOriginCombined_cbre)
get_icc(PlaceVendorOriginSimplified_cbre)
...
get_icc(ssc_prodserv_customer_office_placeorigin_cbre)
...
stargazer::stargazer( PlaceCountry_cbre,
                      ...
                      PlaceOriginCountry_cbre,
                      PlaceOriginCombined_cbre,
                      PlaceOriginSimplified_cbre,
                      PlaceVendorOriginCountry_cbre,
                      PlaceVendorOriginCombined_cbre,
                      PlaceVendorOriginSimplified_cbre,
                      type="text",
                      digits=2)

# get_icc(ssc_prodserv_customer_office_placevendororigin_cbre)
rm(ssc_prodserv_customer_office_placevendororigin_cbre)
stargazer::stargazer(
  ssc_prodserv_customer_office_place_cbre,
  ssc_prodserv_customer_office_vendor_cbre,
  ssc_prodserv_customer_office_origin_cbre, #Needs to be updated
  ssc_prodserv_customer_office_placevendor_cbre,
  ssc_prodserv_customer_office_placevendor_when_cbre, #Old ID count
  ssc_prodserv_customer_office_placeorigin_cbre,
  ssc_prodserv_customer_office_placeorigin_combined_cbre,
  # ssc_prodserv_customer_office_placevendororigin_cbre, #Missing
  ssc_prodserv_customer_office_placevendororigin_combined_cbre,
  type="text",
  digits=2)
...
get_icc(cpsa_prodserv_customer_office_placevendororigin_term)
get_icc(cpsa_prodserv_customer_office_placevendororigin_combined_term)
rm(cpsa_prodserv_customer_office_placevendororigin_term)
# get_icc(psc_When_Office_term)
...
stargazer::stargazer( PlaceCountry_term,
                      ...
                      PlaceVendorCombined_term,
                      PlaceVendorSimplified_term,
                      PlaceOriginCountry_term,
                      PlaceOriginCombined_term,
                      PlaceOriginSimplified_term,
                      PlaceVendorOriginCountry_term,
                      PlaceVendorOriginCombined_term,
                      PlaceVendorOriginSimplified_term,
                      type="text",
                      digits=2)
