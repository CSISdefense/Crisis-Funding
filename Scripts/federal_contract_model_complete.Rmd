...
fed_full <-readr::read_delim(
  "..\\data\\semi_clean\\contract.SP_ContractSampleCriteriaDetailsCustomer.txt",
  col_names=TRUE, 
  delim="\t",
  # , dec=".",
  trim_ws=TRUE,
...
save(file="..\\data\\semi_clean\\Federal_contract_CSIScontractID_complete.Rdata",fed_full)
...
# save(def,file="..\\data\\semi_clean\\Defense_contract_CSIScontractID_detail.Rdata")
 save(fed,file="..\\data\\semi_clean\\Federal_contract_CSIScontractID_detail.Rdata")
  # load("..\\data\\semi_clean\\Federal_contract_CSIScontractID_detail.Rdata")
#Strip out the cuts
