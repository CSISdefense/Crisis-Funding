...
#Frequency Plot
freq_discrete_term_plot(fed_smp,"MaxOfDecisionTree")

#Percent Terminated Plot
discrete_percent_term_plot(fed_smp,"MaxOfDecisionTree")

#Model
Term_01A <- glm (data=fed_smp,
                 b_Term ~ ARRA + Dis + OCO, family=binomial(link="logit"))
display(Term_01A)
...
#Frequency Plot
freq_discrete_term_plot(fed_smp,"Comp")

#Percent Terminated Plot
discrete_percent_term_plot(fed_smp,"Comp")

#Model
Term_02A <- glm (data=fed_smp,
                 b_Term ~ ARRA + Dis + OCO +cb_Comp+b_Urg, family=binomial(link="logit"))
display(Term_02A)

#Plot the new variable and coefficients
#Add the fitted regression line
discrete_fitted_term_model(fed_smp,"cb_Comp") + 
  stat_function(fun = fit_curve, args=list(a=coef(Term_02A)[1],                                                        b=coef(Term_02A)[2]),color="blue")
...
#Add the fitted regression line
discrete_fitted_term_model(fed_smp,"cb_Comp") + 
  stat_function(fun = fit_curve, args=list(a=coef(Term_02B)[1],                                                        b=coef(Term_02B)[2]),color="blue")
...
#Frequency Plot
freq_discrete_term_plot(fed_smp,"EffComp")


#Percent Terminated Plot
discrete_percent_term_plot(fed_smp,"EffComp")

#Model
Term_02C <- glm (data=fed_smp,
                 b_Term ~ ARRA + Dis + OCO +n_Comp + b_Urg,
                 family=binomial(link="logit"))
display(Term_02C)

#Plot the Fitted
#Add the fitted regression line
# discrete_fitted_term_model(fed_smp,"n_Comp") +
#   stat_function(fun = fit_curve, args=list(a=coef(Term_02C)[1],
#                                            b=coef(Term_02C)[2]),
#                 color="blue")
...
#Add the fitted regression line
# discrete_fitted_term_model(fed_smp,"n_Comp") +
#   stat_function(fun = fit_curve, args=list(a=coef(Term_02D)[1],
#                                            b=coef(Term_02D)[2]),
#                 color="blue")
...
```{r Model02E}
#Frequency Plot
freq_discrete_term_plot(fed_smp,"CompOffr")

#Percent Terminated Plot
discrete_percent_term_plot(fed_smp,"CompOffr")

#Model
Term_02E <- glm (data=fed_smp,
...
#Model
Term_02F <- glm (data=fed_smp,
                 b_Term ~ ARRA + Dis + OCO +cn_Offr+
...
#Frequency Plot
freq_continuous_term_plot(fed_smp,"l_Offr")

#Percent Terminated Plot 
binned_percent_term_plot(fed_smp,"l_Offr")

#Percent Terminated Plot
binned_percent_term_plot(fed_smp,"l_Offr","FxCb")

#Percent Terminated Plot
binned_percent_term_plot(fed_smp,"l_Offr","PSR")

#Percent Terminated Plot
binned_percent_term_plot(fed_smp,"l_Offr","Veh")


#Model
Term_02G <- glm (data=fed_smp,
...
CBre_11E <- glm (data=fed_smp,
                 b_Term ~ ARRA + Dis + OCO +cl_Offr +clsqr_Offer, family=binomial(link="logit"))
display(CBre_11E)

#Plot the data and fitted curve
Term_02G_plot<-ggplot(data=fed_smp,
...
#Plot the Fitted
#Add the fitted regression line
discrete_fitted_term_model(fed_smp,"cl_Offr") +
  stat_function(fun = fit_curve, args=list(a=coef(Term_02G)[1],
                                           b=coef(Term_02G)[2]),
                             color="blue")
...
#Plot the data and fitted curve
Term_02H_plot<-ggplot(data=fed_smp,
       aes(y=j_Term,x=cl_Offr))+geom_jitter(alpha=0.11,height=0)+scale_y_sqrt() +
  labs(title="Fitted Linear Model", caption="Source: FPDS, CSIS Analysis")
...
#Add the fitted regression line
discrete_fitted_term_model(fed_smp,"cl_Offr") +
  stat_function(fun = fit_curve, args=list(a=coef(Term_02H)[1],
                                           b=coef(Term_02H)[2]),
                             color="blue")

#Plot the fitted values vs actual results
binned_fitted_versus_term_residuals(Term_02H)



#Plot residuals versus fitted
residuals_term_plot(Term_02H,bins=3)+
  labs(x="Estimated  Pr (Termination)")
...
freq_continuous_term_plot(fed_smp,"UnmodifiedContractBaseAndAllOptionsValue",
               bins=1000)
freq_continuous_term_plot(subset(fed_smp,UnmodifiedContractBaseAndAllOptionsValue<100000000),
               "UnmodifiedContractBaseAndAllOptionsValue",
               bins=1000)

#Frequency Plot for logged ceiling
freq_continuous_term_plot(fed_smp,"l_Ceil")

#Percent Terminated Plot
binned_percent_term_plot(fed_smp,"l_Ceil")
...
#Competition curves
fitted_term_model(fed_smp,"cl_Ceil") + stat_function(fun = Term_02A_curve, 
...
#Frequency Plot
freq_continuous_term_plot(fed_smp,"lsqr_Ceil")

#Percent Terminated Plot
binned_percent_term_plot(fed_smp,"lsqr_Ceil")
...
#Competition curves
fitted_term_model(fed_smp,"cl_Ceil") + stat_function(fun = Term_02B_curve, 
                             args=list(Comp=0),color="blue")+
...
#Frequency Plot
freq_continuous_term_plot(fed_smp,"l_Ceil","EffComp")

#Plot the percent terminated across cost ceiling and competition
binned_percent_term_plot(fed_smp,"l_Ceil","EffComp")
...
#Competition Curves
fitted_term_model(fed_smp,"cl_Ceil") + stat_function(fun = Term_02C_curve, 
                             args=list(Comp=0),color="blue")+
...
freq_continuous_term_plot(fed_smp,"UnmodifiedDays",
               bins=1000)

#Frequency Plot for logged max duration
freq_continuous_term_plot(fed_smp,"l_Days")

#Percent Terminated Plot
binned_percent_term_plot(fed_smp,"l_Days")
...
#Competition Curves
fitted_term_model(fed_smp,"cl_Days") + stat_function(fun = Term_02D_curve, 
...
#Competition Curves
fitted_term_model(fed_smp,"cl_Days") + stat_function(fun = Term_02E_curve, 
                             args=list(Comp=0,Ceil=0),color="blue")+
...
#Frequency Plot
freq_continuous_term_plot(fed_smp,"lsqr_Days")

#Percent Terminated Plot
binned_percent_term_plot(fed_smp,"lsqr_Days")
...
#Competition curves
fitted_term_model(fed_smp,"cl_Ceil") + stat_function(fun = Term_02F_curve, 
                             args=list(Comp=0),color="blue")+
...
#Competition curves
fitted_term_model(fed_smp,"cl_Ceil") + stat_function(fun = Term_02G_curve, 
                             args=list(Comp=0),color="blue")+
...
#Frequency Plot
freq_continuous_term_plot(fed_smp,"l_Days","EffComp")

#Plot the percent terminated across cost ceiling and competition
binned_percent_term_plot(fed_smp,"l_Days","EffComp")
...
#Competition curves
fitted_term_model(fed_smp,"cl_Days") + stat_function(fun = Term_02H_curve, 
                             args=list(Comp=0,Ceil=0),color="blue")+
...
```{r Model13A}
#Frequency Plot
freq_discrete_term_plot(fed_smp,"Veh")

#Percent Terminated Plot 
discrete_percent_term_plot(fed_smp,"Veh")


#Create the model
Term_03A <- glm (data=fed_smp,
                 b_Term ~n_Comp + 
                   cl_Ceil + clsqr_Ceil + cl_Days+ clsqr_Days +
                   SIDV + MIDV + OIDV +
                   n_Comp:cl_Ceil  + cl_Ceil:cl_Days  + n_Comp:cl_Days, family=binomial(link="logit"))
...
#Competition curves
discrete_fitted_term_model(fed_smp,"SIDV") +
...
#Competition curves
discrete_fitted_term_model(fed_smp,"MIDV") +
...
#Competition curves
discrete_fitted_term_model(fed_smp,"OIDV") +
...
#Frequency Plot
freq_continuous_term_plot(fed_smp,"l_Days","Veh")


#Percent Terminated Plot 
binned_percent_term_plot(fed_smp,"l_Days","Veh")

#Create the model
Term_03B <- glm (data=fed_smp,
                 b_Term ~n_Comp + 
                   cl_Ceil + clsqr_Ceil + cl_Days+ clsqr_Days +
                   SIDV + MIDV + OIDV +
...
#Frequency Plot
freq_discrete_term_plot(fed_smp,"EffComp","Veh")

#Percent Terminated Plot 
discrete_percent_term_plot(fed_smp,"EffComp","Veh")


#Create the model
Term_03C <- glm (data=fed_smp,
                 b_Term ~n_Comp + 
                   cl_Ceil + clsqr_Ceil + cl_Days+ clsqr_Days +
                   SIDV + MIDV + OIDV +
                   n_Comp:cl_Ceil  + cl_Ceil:cl_Days  + n_Comp:cl_Days +
...
#Frequency Plot
freq_continuous_term_plot(fed_smp,"l_Ceil","Veh")


#Percent Terminated Plot 
binned_percent_term_plot(fed_smp,"l_Ceil","Veh")

#Create the model

#Create the model
Term_03D <- glm (data=fed_smp,
                 b_Term ~n_Comp + 
                   cl_Ceil + clsqr_Ceil + cl_Days+ clsqr_Days +
                   SIDV + MIDV + OIDV +
                   n_Comp:cl_Ceil  + cl_Ceil:cl_Days  + n_Comp:cl_Days +
...
#Competition curves
discrete_fitted_term_model(fed_smp,"cl_Ceil") +
...
#Frequency Plot
freq_discrete_term_plot(fed_smp,"FxCb")

#Percent Terminated Plot 
discrete_percent_term_plot(fed_smp,"FxCb")


#Create the model
Term_04A <- glm (data=fed_smp,
                 b_Term ~n_Comp + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Comp:cl_Ceil  + cl_Ceil:cl_Days  + n_Comp:cl_Days +
...
#Frequency Plot
freq_continuous_term_plot(fed_smp,"l_Days","FxCb")

#Percent Terminated Plot 
binned_percent_term_plot(fed_smp,"l_Days","FxCb")


#Create the model
Term_04B <- glm (data=fed_smp,
                 b_Term ~n_Comp + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Comp:cl_Ceil  + cl_Ceil:cl_Days  + n_Comp:cl_Days +
...
#Frequency Plot
freq_discrete_term_plot(fed_smp,"FxCb","Veh")

#Percent Terminated Plot 
discrete_percent_term_plot(fed_smp,"FxCb","Veh")

#Create the model
Term_04C <- glm (data=fed_smp,
                 b_Term ~n_Comp + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Fixed +
...
#Vehicle curves
discrete_fitted_term_model(fed_smp,"n_Fixed") +
...
#Frequency Plot
freq_discrete_term_plot(fed_smp,"Fee")

#Percent Terminated Plot 
discrete_percent_term_plot(fed_smp,"Fee")



#Create the model
Term_04D <- glm (data=fed_smp,
                 b_Term ~n_Comp + 
...
#Days curves
discrete_fitted_term_model(fed_smp,"n_Incent") +
...
#Frequency Plot
freq_discrete_term_plot(fed_smp,"Fee","FxCb")+
  theme(axis.text.x = element_text(angle = 90, hjust = 1))

#Percent Terminated Plot 
discrete_percent_term_plot(fed_smp,"Fee","FxCb")+
   theme(axis.text.x = element_text(angle = 90, hjust = 1))



#Create the model
Term_04E <- glm (data=fed_smp,
                 b_Term ~n_Comp + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Comp:cl_Ceil  + cl_Ceil:cl_Days  + n_Comp:cl_Days +
...
#Frequency Plot
freq_discrete_term_plot(fed_smp,"UCA")

#Percent Terminated Plot 
discrete_percent_term_plot(fed_smp,"UCA")



#Create the model
Term_04F <- glm (data=fed_smp,
                 b_Term ~n_Comp + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Comp:cl_Ceil  + cl_Ceil:cl_Days  + n_Comp:cl_Days +
...
#Frequency Plot
freq_discrete_term_plot(fed_smp,"UCA","n_Comp")

#Percent Terminated Plot 
discrete_percent_term_plot(fed_smp,"UCA","n_Comp")



#Create the model
Term_04G <- glm (data=fed_smp,
                 b_Term ~n_Comp + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Comp:cl_Ceil  + cl_Ceil:cl_Days  + n_Comp:cl_Days +
...
#Frequency Plot
freq_continuous_term_plot(fed_smp,"l_Days","UCA")

#Percent Terminated Plot 
binned_percent_term_plot(fed_smp,"l_Days","UCA")


#Create the model
Term_04H <- glm (data=fed_smp,
                 b_Term ~n_Comp + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Comp:cl_Ceil  + cl_Ceil:cl_Days  + n_Comp:cl_Days +
...
#Frequency Plot
freq_discrete_term_plot(fed_smp,"Intl")

#Percent Terminated Plot 
discrete_percent_term_plot(fed_smp,"Intl")



#Create the model
Term_05A <- glm (data=fed_smp,
                 b_Term ~n_Comp + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Comp:cl_Ceil  + cl_Ceil:cl_Days  + n_Comp:cl_Days +
...
#Frequency Plot
freq_discrete_term_plot(fed_smp,"Intl","FxCb")

#Percent Terminated Plot 
discrete_percent_term_plot(fed_smp,"Intl","FxCb")
...
#Frequency Plot
freq_discrete_term_plot(fed_smp,"Intl","Veh")

#Percent Terminated Plot 
discrete_percent_term_plot(fed_smp,"Intl","Veh")



#Create the model
Term_05C <- glm (data=fed_smp,
                 b_Term ~n_Comp + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Comp:cl_Ceil  + cl_Ceil:cl_Days  + n_Comp:cl_Days +
...
#Frequency Plot
freq_discrete_term_plot(fed_smp,"Who")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))


#Percent Terminated Plot 
discrete_percent_term_plot(fed_smp,"Who")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))
...
#Days curves
discrete_fitted_term_model(fed_smp,"b_ODoD") +
...
#Frequency Plot
freq_discrete_term_plot(fed_smp,"EffComp","Who")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))


#Percent Terminated Plot 
discrete_percent_term_plot(fed_smp,"EffComp","Who")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))
...
#Frequency Plot
freq_discrete_term_plot(fed_smp,"PSR")

#Percent Terminated Plot 
discrete_percent_term_plot(fed_smp,"PSR")



#Create the model
Term_08A <- glmer(data=fed_smp,
                 b_Term ~n_Comp + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Comp:cl_Ceil  + cl_Ceil:cl_Days  + n_Comp:cl_Days +
...
#Frequency Plot
freq_discrete_term_plot(fed_smp,"PSR_What")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

#Percent Terminated Plot 
discrete_percent_term_plot(fed_smp,"PSR_What")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))



#Create the model
Term_08B <- glmer(data=fed_smp,
                 b_Term ~n_Comp + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Comp:cl_Ceil  +
...
#Frequency Plot
freq_discrete_term_plot(fed_smp,"PSR_What","EffComp")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

#Percent Terminated Plot 
discrete_percent_term_plot(fed_smp,"EffComp","PSR")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

discrete_percent_term_plot(fed_smp,"EffComp","What")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

discrete_percent_term_plot(fed_smp,"EffComp","PSR_What")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))


#Effective Competition
#Frequency Plot
freq_discrete_term_plot(fed_smp,"PSR_What","Veh")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

#Percent Terminated Plot 
discrete_percent_term_plot(fed_smp,"Veh","PSR")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

discrete_percent_term_plot(fed_smp,"Veh","What")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

discrete_percent_term_plot(fed_smp,"Veh","PSR_What")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

#FxCb
#Frequency Plot
freq_discrete_term_plot(fed_smp,"PSR_What","FxCb")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

#Percent Terminated Plot 
discrete_percent_term_plot(fed_smp,"FxCb","PSR")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

discrete_percent_term_plot(fed_smp,"FxCb","What")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))

discrete_percent_term_plot(fed_smp,"FxCb","PSR_What")+ theme(axis.text.x = element_text(angle = 90, hjust = 1))


Term_08C <- glmer(data=fed_smp,
                 b_Term ~ #n_Comp + 
                   cl_Ceil + cl_Days+ 
                   SIDV + MIDV + OIDV +
                   n_Comp:cl_Ceil  +
