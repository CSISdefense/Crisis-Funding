...
/****** Object:  StoredProcedure [Contract].[SP_ContractDetailsCustomer]    Script Date: 9/14/2017 4:30:27 PM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
ALTER PROCEDURE [Contract].[SP_ContractDetailsCustomer]
