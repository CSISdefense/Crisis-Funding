...
load("data\\clean\\large_crisis_smp.Rdata")
# save(large_crisis_smp,large_crisis_all_with_na,file="Data\\large_crisis_smp.Rdata")
...
# 
# extra_large_crisis_all_with_na<-(extra_large_crisis_all_with_na)
...
save(file="data//clean//fed_sample.Rdata",fed_smp,fed_1m,crisis_all,crisis_all_with_na)
