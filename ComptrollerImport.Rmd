...
OCOsum<-ComptrollerOCObyAccount(MilPersCrossYear)
OCOsum<-rbind(OCOsum,ComptrollerOCObyAccount(OnMcrossYear))
OCOsum<-rbind(OCOsum,ComptrollerOCObyAccount(RFcrossYear))
OCOsum<-rbind(OCOsum,ComptrollerOCObyAccount(ProcCrossYear))
OCOsum<-rbind(OCOsum,ComptrollerOCObyAccount(RDTEcrossYear))
OCOsum<-rbind(OCOsum,ComptrollerOCObyAccount(MilConCrossYear))
```